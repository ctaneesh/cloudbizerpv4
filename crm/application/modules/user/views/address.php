    ...
    <div class="card card-block">
        ...
        <form method="post" id="data_form" class="form-horizontal">
            <div class="row">
                ...
                <hr>
                <div class="col-md-6">
                    <h5><?php echo $this->lang->line('Company Address') ?></h5>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" placeholder="Country" class="form-control margin-bottom" name="shipping_country"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="submit" id="submit-data" class="btn btn-lg btn-primary margin-bottom" value="Update"
