                    ...
                    <div class="row wrapper white-bg page-heading">
                        ...
                        <div class="col-lg-12">
                            ...
                            if ($invoice['status'] != 'canceled') {
                                echo ' <div class="title-action"><a href="' . $link . '"  class="btn btn-sm btn-secondary" title="Partial Payment"
                                ><span class="fa fa-money"></span> '.$this->lang->line('Make Payment').' </a>
                                <a href="' . $linkp . '"  class="btn btn-sm btn-secondary" title="Partial Payment"
                                ><span class="fa fa-print"></span> '.$this->lang->line('Print').' </a>   </div>';
                            } else {
                                echo '<h2 class="btn btn-sm btn-secondary">' . $this->lang->line('Cancelled') . '</h2>';
                            } ?>
                        </div>
                    </div>
