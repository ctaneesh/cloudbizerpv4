        ...
        <div class="grid_3 grid_4 animated fadeInRight table-responsive">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line('Received Quotes') ?></li>
                </ol>
            </nav> 
            <h5><?php echo $this->lang->line('Received Quotes') ?></h5>

            <hr>
            <table id="invoices" class="table table-striped1 zero-configuration dataTable" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th><?php echo $this->lang->line('No') ?></th>
                    <th><?php echo $this->lang->line('Quote')." #"; ?></th>
                    <th><?php echo $this->lang->line('Customer') ?></th>
                    <th class="text-md-center"><?php echo $this->lang->line('Date') ?></th>
                    <th class="text-md-right"><?php echo $this->lang->line('Total') ?></th>
                    <th class="no-sort text-md-center"><?php echo $this->lang->line('Status') ?></th>
