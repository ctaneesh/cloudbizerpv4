                        ...
                        <div id="invoice-items-details" class="pt-2">
                            ...
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    echo '<input type="hidden" name="invoiceshipping" value="' .$invoice['shipping']. '" id="invoiceshipping" />';
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-xs-right" id="subtotalPrice">                                                    
                                                    <?php echo $invoice['subtotal'] ?></td>
                                            </tr>
                                            <tr>
