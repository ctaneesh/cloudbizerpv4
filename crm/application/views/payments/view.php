                    ...
                    <div class="row wrapper white-bg page-heading">
                        ...
                        <div class="col-lg-12">
                            ...
                            if ($invoice['status'] != 'canceled') {
                                echo ' <div class="title-action"><a href="' . $link . '"  class="btn btn-sm btn-success" title="Partial Payment"
                                ><span class="fa fa-money"></span> Make Payment </a>
                                <a href="' . $linkp . '"  class="btn btn-sm btn-info" title="Partial Payment"
                                ><span class="fa fa-print"></span> Print </a>   </div>';
                            } else {
                                echo '<h2 class="btn btn-sm btn-danger">Cancelled</h2>';
                            } ?>
                        </div>
                    </div>
