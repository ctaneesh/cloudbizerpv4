...
<head>
    ...
    <link rel="stylesheet" href="<?php echo assets_url('crm-assets/custom/sweetalert.css'); ?>">
    ...
    <link rel="stylesheet" href="<?php echo assets_url('crm-assets/css/custom.css'); ?>">    
      <?php  $urlname = base_url();
     $main_url = str_replace('/crm', '', $urlname); ?>
     <link rel="stylesheet" type="text/css" href="<?php echo $main_url; ?>assets/css/responsive.css">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    ...
    <script src="<?php echo assets_url('crm-assets/js/validate.js'); ?>"></script>
    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item" style="margin-left: -1rem;margin-top: -12px;"><a href="<?php echo base_url() ?>" class="navbar-brand nav-link"><img
                                alt="branding logo"
                                ...
                                data-collapse="<?php echo substr_replace(base_url(), '', -4); ?>userfiles/theme/small-logo.png"
        ...
        <div class="navbar-container content container-fluid">
            <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
                ...
                if(current_url()==base_url('tickets') || current_url()==base_url('projects')){
...
<div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" id="side">
    ...
    <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main mt-2">
            ...
            <li class="nav-item <?php if ($this->uri->segment(1) == "enquiry") {
                echo 'active';
            } ?>">
                <a href="<?php echo base_url(); ?>enquiry/"> <i class="icon-file"></i><span class="menu-title"> <?php echo $this->lang->line('Request For Quotes'); ?> </span></a>
            </li>
            <li class="nav-item <?php if ($this->uri->segment(1) == "quote") {
                echo 'active';
            } ?>">
                <a href="<?php echo base_url(); ?>quote/"> <i class="icon-pencil-square"></i><span class="menu-title"> <?php echo $this->lang->line('Received Quotes'); ?> </span></a>
            </li>
            ...
            <li class="nav-item <?php if($this->uri->segment(1) == "payments") echo "active"; ?>">
                <a href="<?php echo base_url("payments"); ?>"><i class="icon-cash"></i>
                    <span class="menu-title"><?php echo $this->lang->line('Payment History'); ?></span></a>
            </li>
            <li class="nav-item <?php if($this->uri->segment(1) == "tickets") echo "active"; ?>">
                <a href="<?php echo base_url("tickets"); ?>"><i class="icon-ticket"></i>
                    <span class="menu-title"><?php echo $this->lang->line('Support Tickets') ?></span></a>
            </li>
            <li class="nav-item <?php if($this->uri->segment(1) == "projects") echo "active"; ?> d-none">
                <a href="<?php echo base_url("projects"); ?>"><i class="icon-stack"></i>
                    <span class="menu-title"><?php echo $this->lang->line('Project'); ?></span></a>
            </li>
            ...
            <li class="d-none nav-item <?php if ($this->uri->segment(1) == "address") {
                echo 'active';
            } ?>">
