        ...
        <div class="card-header border-bottom">   
            <nav aria-label="breadcrumb">
                <?php
                    ...
                    $invoice['tid'] = ($return_exists > 0) ? $invoice['tid'] : $lastinvoice+1;
                    $return_number = $prefix.$invoice['tid'];
                ?>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?= base_url('dashboard') ?>"><?php echo $this->lang->line('Dashboard'); ?></a></li>
                    <li class="breadcrumb-item"><a href="<?= base_url('stockreturn') ?>"><?php echo  $this->lang->line('Purchase Returns') ?></a></li>
            ...
            <div class="row">
                     ...
                     <?php 
                        ...
                        if (!empty($trackingdata)) {     
                            ...
                            if (!empty($trackingdata['purchase_reciept_return_number'])) { 
                                echo '<li class="active">' .  $trackingdata['purchase_reciept_return_number'] . '</li>';
                            }
                            else{
                ...
                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 text-right">
                     ...
                     <?php
                        ...
                        if(($return_exists) && ($invoice['prepared_flg']!=1 || $invoice['return_status'] =='Sent'))
                        {
                           $approvebtn="d-none";
                           $acceptbtn="d-none";
                        }
                        if(($return_exists) && ($invoice['approvalflg']==1))
                        {
                           $approvebtn="d-none";
                           $updatestockcls ="";
                        }
                            ...
                            $addrowclass_withemp="";
                            switch (true) {
                                case ($invoice['prepared_flg'] == 0 && $invoice['return_status'] != "Draft"):
                                    $msgcls = "d-none";
                ...
                <div class="row wrapper white-bg page-heading <?=$marginbottom?>">
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        ...
                        <div class="title-action">
                            <a href='<?= base_url("stockreturn/purchase_return_payment?id=" . $invoice['iid'] . "&csd=" . $invoice['customer_id']) ?>' class="btn btn-sm  btn-secondary  <?php echo $enabledisablecls; ?> <?=$paymentclass?>" title="Payment Received"><span class="fa fa-money"></span> <?php echo $this->lang->line('Payment Received') ?> </a>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 text-lg-right text-md-right text-sm-left">
                        <?php
                        if(($return_exists>0))
                        { ?>
                            ...
                            <div class="btn-group ">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" target="_blank"
                                        href="<?= base_url('billing/purchase_return_debit_memo?id=' . $invoice['iid'] . '&token=' . $validtoken); ?>"><?php echo $this->lang->line('Debit Memo') ?></a>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
                                    ...
                                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12 cmp-pnl">
                                        <div class="inner-cmp-pnl">
                                            <div class="form-row">
                                                ...
                                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-xs-12 d-none">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Purchase Order #" name="invocieno"  value="<?php echo $invoice['tid']; ?>" readonly >
                                                        <input id="receipt_id" type="hidden"  name="iid" value="<?php echo $invoice['iid']; ?>">
                                                        <input id="stock_return_number" type="hidden"  name="stock_return_number" value="<?php echo $return_number ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Reference #"  id="refer" name="refer"  data-original-value="<?php echo $invoice['refer']; ?>" title="Reference" value="<?php echo $invoice['refer'] ?>" <?=$element_readonly?> >
                                                    </div>
                                                </div>
                                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-xs-12 d-none"><label for="invociedate" class="col-form-label"> <?php echo $this->lang->line('Order Date') ?></label>
                                                        <input type="date" class="form-control" placeholder="Billing Date" name="invoicedate" autocomplete="false" value="<?php echo ($invoice['invoicedate']) ?>" data-original-value="<?php echo $invoice['invoicedate']; ?>">
                                                </div>
                                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-xs-12 d-none">
                                            ...
                                            { ?>
                                                ...
                                                <input type="hidden" name="purchase_reciept_number" id="purchase_reciept_number" value="<?=$invoice['receiptnumber']?>">
                                                <div class="col-12">
                                                    <div class="row">
                            ...
                            <div id="saman-row">
                                <table class="table table-striped table-bordered zero-configuration dataTable">
                                    ...
                                    if($products)
                                    {
                                        ...
                                        {
                                            $productcode="";
                                            $subtotal = number_format($row['price']*$row['product_qty_recieved'],2);
                                            $grand_total += ($row['price']*$row['product_qty_recieved']);
                                            $product_name_with_code = $row['product'].'('.$row['code'].') - ';
                                            echo '<tr >';
                                            echo '<td class="text-center serial-number">'.$k++.'</td>';
                                            echo '<td><input type="text" class="form-control '.$receipt_class.'" id="code-' . $i . '" name="code[]" value="' . $row['code'] . '" '.$reciptclass.' '.$element_readonly.'>
                                            </td>
                                            <td><input type="text" class="form-control productname '.$receipt_class.'" name="product_name[]" placeholder="Enter Product name or Code"  value="' . $row['product'] . '" '.$reciptclass.' '.$element_readonly.'>
                                            </td>';
                                            
                                            if(!empty($row['purchase_reciept_id']))
                                            {
                                                echo '<td class="text-center"><strong class="text-center">'.$row['product_quantity_recieved'].'</strong><input type="hidden" name="received_qty[]"   id="received_qty-' . $i . '" value="'.$row['product_qty_recieved'].'" '.$element_readonly.'></td>';
                                            
                                            }
                                            echo '<td><input type="number" class="form-control req amnt" name="product_qty[]" id="amount-' . $i . '" onkeypress="return isNumber(event)" onkeyup="checkqty(' . $i . '),rowTotal(' . $i . '), billUpyog()" autocomplete="off" title="'.$product_name_with_code.'Return Quantity" data-original-value="0"  value="0" '.$element_readonly.'><input type="hidden" name="old_product_qty[]" value="' . intval($row['qty']) . '" '.$element_readonly.'></td>';
                                            ...
                                            echo '<td class="text-center"><input type="number" class="form-control" name="damage[]"   id="damage-' . $i . '" value="'.intval($row['damaged_qty']).'" '.$element_readonly.' onkeyup="damageqtycheck(' . $i . ')" ></td>';
                                            echo '<td><input type="text" class="form-control text-right req prc '.$receipt_class.'" name="product_price[]" id="price-' . $i . '" onkeypress="return isNumber(event)" onkeyup="rowTotal(' . $i . '), billUpyog()" autocomplete="off" value="' .$row['price'] . '" '.$element_readonly.'></td>
                      ...
                      <div class="row">
                        <div class="col-4">
                            <?php 
                                ...
                                <?php }
                                if(($return_exists>0) && ((!empty($invoice['approved_by'])) && ($invoice['approved_by']==$this->session->userdata('id') && $invoice['prepared_flg']==1) && ($invoice['approvalflg']=='1')))
                                {
                                    $draftcls ="";
                        ...
                        <div class="col-8 text-right">
                            ...
                            ?>
                            <input type="submit" class="btn  btn-lg <?=$sendbtn_class?> send-strock-return-btn <?=$approvebtn?> <?=$accpetthenhide?>"  value="<?php echo $this->lang->line('Send Stock Return') ?>" data-loading-text="Creating...">
                            <?php
                            if(($return_exists) && ($invoice['approved_by']==$this->session->userdata('id')  &&  $invoice['approvalflg']=='1')){
                                    ?>
...
$(document).ready(function() {
    ...
    $("#stock_return_prepared_btn_draft1").on("click", function(e) {        
        ...
        if(stockreturnid){
            targeturl = baseurl +'stockreturn/draftaction_sub';
        }
        else{
            targeturl = baseurl +'stockreturn/draftaction';
        }
      //  var formData = $("#data_form").serialize(); 
      var form = $('#data_form')[0];
      var formData = new FormData(form); 
      formData.append('changedFields', JSON.stringify(changedFields));
        $.ajax({
            ...
            success: function(response) {
                ...
                // stockreturn/create?id=1&token=0ebdf108dc24b5d08ca2329c0a7048458e4b85c7    
                window.location.href = baseurl + 'stockreturn/create?pid='+id+'&token='+token;     
                // location.reload();
            },
            error: function(xhr, status, error) {
                    // Handle error
