<div class="content-body">
    <div class="card">
        <div class="card-header border-bottom">
            <h4 class="card-title"><?php echo $this->lang->line('Manage')." ".$this->lang->line('Stock Return'). " #".(1000+$invoice['iid']); ?></h4>
        ...
        <div class="card-content">
            ...
            <div id="invoice-template" class="card-body">
                <div class="row wrapper white-bg page-heading mb-1">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                        ...
                        if ($invoice['status'] != 'canceled') { ?>
                            ...
                            echo $eurl ?>" class="btn btn-sm btn-secondary d-none"><i
                            ...
                            <a href="#part_payment" data-toggle="modal" data-remote="false" data-type="reminder"
                               class="btn btn-sm btn-large btn-secondary" title="Partial Payment"
                            ...
                            <a href="#pop_model" data-toggle="modal" data-remote="false"
                               class="btn btn-sm btn-success" title="Change Status"
                            ><span class="fa fa-retweet"></span> <?php echo $this->lang->line('Change Status') ?></a>
                            <a href="#cancel-bill" class="btn btn-sm btn-secondary" id="cancel-bill_p"><i
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 text-lg-right text-md-right text-sm-left">
                        
                        <a href="<?php echo $link; ?>" class="btn btn-sm btn-secondary" target="_blank"><i
                                    class="fa fa-globe"></i> <?php echo $this->lang->line('Public Preview') ?>
                        </a>
                      
                        <div class="btn-group ">
                            <button type="button" class="btn btn-sm btn-secondary btn-min-width dropdown-toggle"
                ...
                <div id="invoice-company-details" class="row ">
                    ...
                    <div class="col-md-6 col-sm-12 text-xs-center text-md-right">
                        ...
                        <p class=""> <?php echo prefix(4) . $invoice['tid'] . '</p>
                            <p class="">Reference:' . $invoice['refer'] . '</p>'; ?>
                        <p  class=""><?php echo $this->lang->line('Payment Status') ?>:
                            <u><strong  id="pstatus">
                                <?php echo $this->lang->line(ucwords($invoice['status'])) ?></strong>
                            </u>
                        </p>
                        <ul class="px-0 list-unstyled">
                            <li><?php echo $this->lang->line('Gross Amount') ?> : 
                                <span class="lead text-bold-800"><?= amountExchange($invoice['total'], 0, $this->aauth->get_user()->loc) ?></span>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-xs-right no-border"><?php echo amountExchange($invoice['tax'], 0, $this->aauth->get_user()->loc) ?></td>
                                    </tr>
                                    <tr>
                                        <td class="no-border"><?php echo $this->lang->line('Discount') ?></td>
                                        <td class="text-xs-right no-border"><?php echo amountExchange($invoice['discount'], 0, $this->aauth->get_user()->loc) ?></td>
                                    </tr>
                                    <tr>
                                        <td class="no-border"><?php echo $this->lang->line('Shipping') ?></td>
                                        <td class="text-xs-right no-border"><?php echo amountExchange($invoice['shipping'], 0, $this->aauth->get_user()->loc) ?></td>
                                    </tr>
                                    <tr>
                                        <td class="text-bold-800 no-border"><?php echo $this->lang->line('Total') ?></td>
                                        <td class="text-bold-800 text-xs-right no-border"> <?php echo amountExchange($invoice['total'], 0, $this->aauth->get_user()->loc) ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="bg-grey bg-lighten-4">
                                        <td class="text-bold-800 no-border"><?php echo $this->lang->line('Balance Due') ?></td>
                                        <td class="text-bold-800 text-xs-right no-border"> <?php $myp = '';
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="payment">
                    ...
                    <div class="row">
                        <div class="col"><label for="pmethod"  class="col-form-label"><?php echo $this->lang->line('Payment Method') ?></label>
                            <select name="pmethod" class="form-control">
                                <option value="Cash"><?php echo $this->lang->line('Cash') ?></option>
                                <option value="Card"><?php echo $this->lang->line('Card') ?></option>
                                <option value="Bank">Bank</option>
                            </select><label for="account"  class="col-form-label"><?php echo $this->lang->line('Account') ?></label>
                    ...
                    <div class="row">
                        <div class="col"><label for="shortnote"  class="col-form-label"><?php echo $this->lang->line('Note') ?></label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="emailbody" style="display: none;">
                <form id="sendbill">
                    ...
                    <div class="row">
                        <div class="col"><label for="shortnote" class="col-form-label"><?php echo $this->lang->line('Customer Name') ?></label>
                            <input type="text" class="form-control" name="customername" value="<?php echo $invoice['name'] ?>"></div>
                    </div>
                    <div class="row">
                        <div class="col"><label for="shortnote"  class="col-form-label"><?php echo $this->lang->line('Subject') ?></label>
                            <input type="text" class="form-control" name="subject" id="subject">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col"><label for="shortnote"  class="col-form-label"><?php echo $this->lang->line('Message') ?></label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_model">
                    ...
                    <div class="col-12">
                        <div class="col-xs-12 mb-1"><label for="pmethod" class="col-form-label"><?php echo $this->lang->line('Mark As') ?></label>
