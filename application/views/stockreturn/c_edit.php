<div class="content-body">
    <div class="card">
        <div class="card-header border-bottom">
            <h4 class="card-title"><?php echo $this->lang->line('Customer')." ".$this->lang->line('Stock Return')." #".$invoice['tid']; ?></h4>
                        ...
                        <div id="saman-row">
                            <table class="table table-striped table-bordered zero-configuration dataTable">
                                ...
                                <tr class="sub_c" style="display: table-row;">
                                    ...
                                    <td colspan="2" class="no-border"></td>
                                    <td align="right" colspan="4" class="no-border"><input type="submit" class="btn btn-lg btn-primary sub-btn"
                                                                         value="<?php echo $this->lang->line('Update')." ".$this->lang->line('Stock Return') ?>"
                                                                         id="submit-data"
