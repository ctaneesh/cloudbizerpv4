<div class="content-body">
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                ...
                <div class="table-container">
                    <table id="invoices_c" class="table table-striped table-bordered zero-configuration" style="width:100%">
                        <thead>
                        <tr>
    ...
    <script type="text/javascript">
        ...
        function draw_data(start_date = '', end_date = '') {
            ...
            $("#invoices_c tbody tr td[colspan='7']").removeAttr("colspan");
            startsection = "";
            endsection = "";
            if(start_date ==''){       
                $('#invoices_c_length label').css('margin-top', '5px');
            }
            if(start_date !=''){
                start_date = date_convert(start_date);
                startsection = "<label>Results from : </label><strong> "+start_date+"</strong>";        
                $('#invoices_c_length label').css('margin-top', '10px');
            }
            if(end_date!=''){
