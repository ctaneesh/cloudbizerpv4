<div class="content-body">
	<div class="card">
        <div class="card-header border-bottom">
            <h4 class="card-title"><?php echo $this->lang->line('New'). " ".$this->lang->line('Customer')." ".$this->lang->line('Stock Return'); ?></h4>
							...
							<div id="customerpanel" class="inner-cmp-pnl">
								<div class="form-group row">
									...
									<div class="frmSearch col-sm-12">
										<label for="cst" class="col-form-label"><?php echo $this->lang->line('Search Customer') ?> </label>
						...
						<div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12 cmp-pnl">
							<div class="inner-cmp-pnl">
								<div class="form-group row">
									...
									<div class="col-sm-12">
										<h3 class="title-sub"><?php echo $this->lang->line('Stock Return')." ". $this->lang->line('Details') ?> </h3>
									</div>
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-xs-12"><label for="invocieno"
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-xs-12"><label for="invociedate"
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-xs-12"><label for="invocieduedate"
																 class="col-form-label"><?php echo $this->lang->line('Order Due Date') ?> </label>
						...
						<table class="table table-striped table-bordered zero-configuration dataTable">
							...
							<tr class="sub_c" style="display: table-row;">
								...
								<td align="right" colspan="4" class="no-border">
									<input type="submit" class="btn btn-lg btn-primary sub-btn" value="<?php echo $this->lang->line('Generate')." ".$this->lang->line('Stock Return') ?>" id="submit-data" data-loading-text="Creating...">
