<div class="content-body">
    <div class="card">
        <div class="card-header border-bottom">
            <h4 class="card-title"><?php echo $this->lang->line('Supplier')." ".$this->lang->line('Stock Return'). " #".(1000+$invoice['iid']); ?></h4>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="frmSearch col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="cst" id="supplier-box"
                                               placeholder="<?php echo $this->lang->line('Enter Supplier Name or Mobile Number to search') ?>"
                                               autocomplete="off"/>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Purchase Order #"
                                                       name="invocieno" value="<?php echo $invoice['tid']; ?>" readonly><input
                        ...
                        <div id="saman-row">
                            <table class="table table-striped table-bordered zero-configuration dataTable">
                                ...
                                foreach ($products as $row) {
                                    ...
                                    </tr><tr class="desc_p"><td colspan="8"><textarea id="dpid-' . $i . '" class="form-control" name="product_description[]" placeholder="Enter Product description" autocomplete="off">' . $row['product_des'] . '</textarea></td></tr>';
                                    $i++;
                                } ?>
