<div class="content-body">
	<div class="card">
		<div class="card-header border-bottom">
			<h5 class="title"><?php echo $this->lang->line('Customer') . ' ' . $this->lang->line('Stock Return') ?> <a
		...
		<div class="card-content">
			...
			<div class="card-body">		
				...
				<div class="table-container">
					<table id="invoices_stc" class="table table-striped table-bordered zero-configuration" style="width:100% !important;">
						<thead>
						<tr>
