                                    ...
                                    foreach ($accountparent[$coaHeaderId] as $parentId => $childAccounts) {
                                        foreach ($accountlists[$coaHeaderId] as $acc) {
                                            if ($acc['id'] == $parentId && !in_array($parentId, $printedParents)) {
                                                echo '<option disabled style="font-weight:bold;">' . htmlspecialchars($acc['holder']) . '</option>';
                ...
                <div class="form-group row">                
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                        <label class="col-form-label" for="address"><?php echo $this->lang->line('General Expenses') ?><span class="compulsoryfld">*</span></label>
                            ...
                            // $previous_general_expenses ="";
                            // $accountspayableflg=1;
                            // echo '<select name="general_expenses" id="general_expenses" class="form-control">';
                            // echo '<option value="">Select Type</option>';
                            // foreach ($accountheaders as $parentItem) {
                            //     $coaHeaderId = $parentItem['coa_header_id'];
                            //     $coaHeader = $parentItem['coa_header'];
                            ...
                            //         $acn = $row['acn'];
                            //         $selted = "";
                            //         if ($last_log['general_expenses'] == $acn & $accountspayableflg==1) {
                            //             $previous_general_expenses = $acn." - ".htmlspecialchars($holder);
                            //             $accountspayableflg=0;
                            //         }
                            //         if ($defaultaccounts['general_expenses'] == $acn) {
                            //             $selted = 'selected';
                            //         }
                            //         echo '<option value="' . htmlspecialchars($acn) . '" data-id="' . htmlspecialchars($holder) . '" ' . $selted . '>' . $acn." - ".htmlspecialchars($holder) . '</option>';
                            ...
                            // }
                            // echo '</select>';
                            // echo '<label class="col-form-label"><i>'.$this->lang->line('Previous').' : '.$previous_general_expenses.'</i></label>';
                            ?>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                        <label class="col-form-label" for="address"><?php echo $this->lang->line('Sales Discount') ?><span class="compulsoryfld">*</span></label>
                            ...
                            // $previous_sales_discount ="";
                            // $sales_discountflg=1;
                            // echo '<select name="sales_discount" id="sales_discount" class="form-control">';
                            // echo '<option value="">Select Type</option>';
                            // foreach ($accountheaders as $parentItem) {
                            //     $coaHeaderId = $parentItem['coa_header_id'];
                            //     $coaHeader = $parentItem['coa_header'];
                            ...
                            //         $acn = $row['acn'];
                            //         $selted = "";
                            //         if ($last_log['sales_discount'] == $acn & $sales_discountflg==1) {
                            //             $previous_sales_discount = $acn." - ".htmlspecialchars($holder);
                            //             $sales_discountflg=0;
                            //         }
                            //         if ($defaultaccounts['sales_discount'] == $acn) {
                            //             $selted = 'selected';
                            //         }
                            //         echo '<option value="' . htmlspecialchars($acn) . '" data-id="' . htmlspecialchars($holder) . '" ' . $selted . '>' . $acn." - ".htmlspecialchars($holder) . '</option>';
                            ...
                            // }
                            // echo '</select>';
                            // echo '<label class="col-form-label"><i>'.$this->lang->line('Previous').' : '.$previous_sales_discount.'</i></label>';
                            ?>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                        <label class="col-form-label" for="address"><?php echo $this->lang->line('Order Discount') ?><span class="compulsoryfld">*</span></label>
                            ...
                            // $previous_order_discount ="";
                            // $order_discountflg=1;
                            // echo '<select name="order_discount" id="order_discount" class="form-control">';
                            // echo '<option value="">Select Type</option>';
                            // foreach ($accountheaders as $parentItem) {
                            //     $coaHeaderId = $parentItem['coa_header_id'];
                            //     $coaHeader = $parentItem['coa_header'];
                            ...
                            //         $acn = $row['acn'];
                            //         $selted = "";
                            //         if ($last_log['order_discount'] == $acn & $order_discountflg==1) {
                            //             $previous_order_discount = $acn." - ".htmlspecialchars($holder);
                            //             $order_discountflg=0;
                            //         }
                            //         if ($defaultaccounts['order_discount'] == $acn) {
                            //             $selted = 'selected';
                            //         }
                            //         echo '<option value="' . htmlspecialchars($acn) . '" data-id="' . htmlspecialchars($holder) . '" ' . $selted . '>' . $acn." - ".htmlspecialchars($holder) . '</option>';
                            ...
                            // }
                            // echo '</select>';
                            // echo '<label class="col-form-label"><i>'.$this->lang->line('Previous').' : '.$previous_order_discount.'</i></label>';
                            ?>
                    </div>
