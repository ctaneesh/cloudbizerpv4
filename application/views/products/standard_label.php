        ...
        <div class="card-content">
            ...
            <div class="card-body">
                ...
                <div class="form-group row" style="display: none">
                    ...
                    <div class="col-sm-2"><label class="col-form-label"  for="width">Height</label>
                    ...
                    <div class="col-sm-2"><label class="col-form-label" for="width">BarCode height</label>
                    ...
                    <div class="col-sm-1 mt-2">
                        <input type="submit" id="print_btn" class="btn btn-crud btn-lg btn-primary margin-bottom"
