                ...
                <div class="table-container">
                    <table id="catgtable" class="table table-striped table-bordered zero-configuration" style="width:100%;">
                        ...
                        foreach ($cat as $row) {
                            ...
                            <td><a class='btn btn-secondary  btn-sm' href='" . base_url() . "productcategory/report_product?id=" . $cid . "' target='_blank' title='Reports'> <span class='fa fa-pie-chart'></span></a> <a href='" . base_url("productcategory/edit?id=$cid") . "' class='btn btn-secondary btn-sm' title='Edit'><i class='fa fa-pencil'></i> </a> <a href='#' data-object-id='" . $cid . "' class='btn btn-secondary btn-sm delete-object' title='Delete'><i class='fa fa-trash'></i></a></td></tr>";
