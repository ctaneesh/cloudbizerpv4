        ...
        <div class="card-body">
            <form method="post" id="data_form">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6"><label class="col-form-label"
                                                 for="Arabic Name"><?php echo $this->lang->line('Arabic Name') ?>*</label>
                        <input type="text" placeholder="Arabic Name"   class="form-control required" name="arabic_name">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6"><label class="col-form-label"
                                                 for="manufacturer_id"><?php //echo $this->lang->line('Manufa')
                                                 echo "Manufacturers" ?>
                            *</label>
                    ...
                    <div class="col-sm-6"><label class="col-form-label" for="manufacturer_partno"><?php echo $this->lang->line('Manufacturer Partno');  ?></label>
                        
                        <input type="text" placeholder="Manufacturer partno"   class="form-control required" name="manufacturer_partno">

                    </div>
                    <div class="col-sm-6"><label class="col-form-label" for="prefered_vendor"><?php echo $this->lang->line('Prefered Vendor');?></label>
                        
                        <input type="text" placeholder="Prefered Vendor"   class="form-control required" name="prefered_vendor">

                    </div>
                    <div class="col-sm-3"><label class="col-form-label" for="unit_weight"><?php echo $this->lang->line('Unit Weight');  ?></label>
                        
                        <input type="number" placeholder="Unit weight"   class="form-control required" name="unit_weight">

                    </div>
                    <div class="col-sm-3"><label class="col-form-label" for="kg_quantity"><?php echo $this->lang->line('Kg Quantity'); ?></label>
                        
                        <input type="number" placeholder="kg quantity"   class="form-control required" name="kg_quantity">
