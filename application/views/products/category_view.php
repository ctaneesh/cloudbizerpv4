    ...
    <div class="card">
        ...
        <div class="card-content">
            <div id="notify" class="alert alert-success" style="display:none;">
                ...
                <?php if (isset($cat[0])) {
                    ?>
                    <h4 class="card-title"> <?php echo $this->lang->line('Sub') ?><?php echo $this->lang->line('Categories') ?>
                    </h4>
                    <hr>
                    <div class="table-scroll">
                        <table id="catgtable" class="table table-striped table-bordered zero-configuration dataTable">
                            <thead>
                                <tr>
                                    <th>#</th>
                            ...
                            foreach ($cat as $row) {
                                ...
                                <td><a href='" . base_url("productcategory/view?id=$cid&sub=true") . "' class='btn btn-success btn-sm'><i class='fa fa-eye'></i> " . $this->lang->line('View') . "</a>&nbsp;  <a href='" . base_url("productcategory/edit?id=$cid") . "' class='btn btn-warning btn-sm'><i class='fa fa-pencil'></i> " . $this->lang->line('Edit') . "</a>&nbsp;<a href='#' data-object-id='" . $cid . "' class='btn btn-danger btn-sm delete-object2' title='Delete'><i class='fa fa-trash'></i></a></td></tr>";
                                // &nbsp; <a class='btn btn-pink  btn-sm' href='" . base_url() . "productcategory/report_product?id=" . $cid . "&sub=true' target='_blank'> <span class='fa fa-pie-chart'></span>" . $this->lang->line('Sales') . "</a>
                ...
                <?php } ?>
                    ...
                    <div class="table-container mt-2 table-scroll">
                ...
                table = $('#productstable').DataTable({
                    ...
                    "ajax": {
                        "url": "<?php if (isset($sub)) {
                            ...
                            $t = '0';
                        } echo site_url('products/product_listcat') . '?id=' . $id . '&sub=' . $t;  ?>",
                        "type": "POST",
