    ...
    <div class="card">
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                ...
                <div class="media">
                    <div class="media-left pr-2"><span class="avatar avatar-sm"><img src="' . base_url('userfiles/employee/' . $row->picture) . '"></span></div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="emailbody">
                    <form class="sendpm">
                        <div class="row">
                            <div class="col"><label
                                        for="username" class="col-form-label"><?php echo $this->lang->line('Employee Username') ?></label>
                        ...
                        <div class="row">
                            <div class="col"><label
                                        for="shortnote"  class="col-form-label"><?php echo $this->lang->line('Subject') ?></label>
                        ...
                        <div class="row">
                            <div class="col"><label
                                        for="shortnote"  class="col-form-label"><?php echo $this->lang->line('Message') ?></label>
                                <textarea name="text" class="summernote" id="contents" title="Contents"></textarea>
                            </div>
                        </div>

                        <input type="hidden" class="form-control" id="invoiceid" name="tid" value="">
