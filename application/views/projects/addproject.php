    ...
    <div class="card">
        <div class="card-header">
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line('Add Project') ?></li>
                </ol>
            </nav>
            <h4 class="card-title"><?php echo $this->lang->line('Add Project') ?></h4><hr>
            ...
            <div class="card-body">
                ...
                <form method="post" id="data_form" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                            <label class="col-form-label" for="pay_cat"><?php echo $this->lang->line('Priority') ?></label>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                            <label class="col-form-label" for="name"><?php echo $this->lang->line('Customer Can View') ?></label>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                            <label class="col-form-label" for="name"><?php echo $this->lang->line('Customer Can Comment') ?></label>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                            <label class="col-form-label" for="edate"><?php echo $this->lang->line('Start Date') ?></label>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                            <label class="col-form-label" for="edate"><?php echo $this->lang->line('Due Date') ?><span class="compulsoryfld">*</span></label>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                            <label class="col-form-label" for="employee[]"><?php echo $this->lang->line('Assign to') ?></label>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                            <label class="col-form-label"   for="name">Link to calendar</label>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                            <label class="col-form-label"  for="tags"><?php echo $this->lang->line('Tags') ?><span class="compulsoryfld">*</span></label>
                            <input type="text" placeholder="Tags"
                                   class="form-control margin-bottom  required" name="tags">
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                            <label class="col-form-label"  for="name">Task Communication</label>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12" id="hidden_div" style="display: none;">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 submit-section text-right">
                            <input type="submit" id="submit-btn" class="btn btn-primary btn-lg margin-bottom btn-crud"
        ...
        if ($("#data_form").valid()) {
            ...
            Swal.fire({
               ...
               if (result.isConfirmed) {  
                    $.ajax({
                        type: 'POST',
                        url: baseurl + 'projects/addproject',
                        data: formData,
                        contentType: false,
                        processData: false,
                        dataType: "json",
