                    ...
                    <div class="card-body">
                        <div class="media d-flex">
                            ...
                            <div class="align-self-center">
                                <i class="fa fa-clock-o font-large-2 float-right"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="media d-flex">
                            ...
                            <div class="align-self-center">
                                <i class="fa fa-refresh font-large-2 float-right"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="media d-flex">
                            ...
                            <div class="align-self-center">
                                <i class="fa fa-flag-checkered font-large-2 float-right"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left">
                                <h3 class="" id="dash_6"><?php echo $totalt ?></h3>
                                <span><?php echo $this->lang->line('Total') ?></span>
                            </div>
                            <div class="align-self-center">
                                <i class="icon-support font-large-2 float-right"></i>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <input id="fileupload" type="file" name="files[]" multiple>
                    ...
                    <div class="tab-pane fade" id="notes" role="tabpanel" aria-labelledby="notes-tab"
                        ...
                        <form method="post" id="data_form">
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <textarea class="summernote" placeholder=" Note" autocomplete="false" rows="3" name="content"><?php echo $project['note']; ?></textarea>
                                </div>
                                <div class="col-12 responsive-text-right">
                                    <input type="submit" class="btn  btn-primary sub-btn"
                                           value="<?php echo $this->lang->line('Update') ?> "
                                           id="submit-btn" data-loading-text="Creating...">
                                </div>
                            </div>
                    ...
                    <!--notes-->
                    <!--invoices-->
                    <div class="tab-pane fade d-none" id="invoices" role="tabpanel" aria-labelledby="invoices-tab"
                         aria-expanded="false">
                    ...
                    <div class="tab-pane fade" id="comments" role="tabpanel" aria-labelledby="comments-tab"
                        ...
                        <form method="post" id="data_form2">
                            <div class="form-row">
                                <div class="col-sm-12">
                                    <textarea class="summernote" placeholder=" Note" autocomplete="false" rows="3" name="content" required></textarea>
                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form id="form_model">
                        <div class="modal-body">
                            <div class="col-xs-12 mb-1" id="description"></div>
                            <div class="col-xs-12 mb-1"><?php echo $this->lang->line('Priority') ?> <strong><span    id="priority"></span></strong></div>
...
<script>
    ...
    $("#submit-btn").on("click", function (e) {
        ...
        if ($("#data_form").valid()) {
            ...
            Swal.fire({
               title: "Are you sure?",
               text: "Do you want to update note?",
               icon: "question",
    ...
    $("#submit-btn2").on("click", function (e) {
        ...
        if ($("#data_form").valid()) {
            ...
            Swal.fire({
               title: "Are you sure?",
               text: "Do you want to update comment?",
               icon: "question",
               showCancelButton: true,
               confirmButtonColor: '#3085d6',
               cancelButtonColor: '#d33',
               ...
               if (result.isConfirmed) {  
                    $.ajax({
                        type: 'POST',
                        url: baseurl + 'projects/addcomment',
                        data: formData,
                        contentType: false,
                        processData: false,
                        dataType: "json",
