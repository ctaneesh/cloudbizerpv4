...
<div class="row mt-2">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-12">
        <a href="<?php echo base_url(); ?>invoices/" target="_blank">
            <div class="card pt-0">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-12">
        <a href="<?php echo base_url(); ?>SalesOrders/" target="_blank">
            <div class="card pt-0">
                <div class="card-content">
                    <div class="media align-items-stretch">
        ...
        <div class="card">
            ...
            <div class="card-content px-1">
                <div id="recent-buyers" class="media-list height-450  mt-1 position-relative">
                    <?php
                    if (isset($recent_buy[0]['customer_id'])) {

                        foreach ($recent_buy as $item) {

                            echo '       <a href="' . base_url('customers/view?id=' . $item['customer_id']) . '" class="media border-0">
                        ...
                        <div class="media-body w-100">
                            ...
                            <p class="list-group-item-text mb-0"><span class="st-' . $item['status'] . '">' . $this->lang->line(ucwords($item['status'])) . '</span></p>
                        </div>
                    </a>';
            ...
            <div class="card-header">
                ...
                <div class="heading-elements">
                    <p><span class="float-right"> <a
                                ...
                                <a href="<?php echo base_url() ?>pos_invoices" class="btn btn-blue btn-sm rounded"><?php echo $this->lang->line('POS') ?></a></span>
                    </p>
                </div>
            </div>
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="recent-orders" class="table table-hover table-striped table-bordered zero-configuration dataTable">
                        <thead>
                        <tr>
                            <th><?php echo $this->lang->line('Invoices') ?>#</th>
                            <th><?php echo $this->lang->line('Customer') ?></th>
                            <th class="text-center"><?php echo $this->lang->line('Status') ?></th>
                            <th class="text-center"><?php echo $this->lang->line('Due') ?></th>
                            <th class="text-right"><?php 
                             $this->configurations = $this->session->userdata('configurations');
                            echo $this->lang->line('Amount')."(".$this->configurations['config_currency'].")"; ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
                        foreach ($recent as $item) {
                            ...
                            if ($item['i_class'] == 0) {
                                ...
                                $url = base_url() . $page . '/create?id=' . $item['invoice_number'];
                            } elseif ($item['i_class'] == 1) {
                                $page = 'pos_invoices';
                                $t = 'POS ';
                                $url = base_url() . $page . '/view?id=' . $item['invoice_number'];
                            }
                            echo '    <tr>
                                <td class="text-truncate"><a href="' . $url . '">' . $t . ' ' . $invoice_number . '</a></td>
                             
                                <td class="text-truncate"> ' . $item['name'] . '</td>
                                <td class="text-truncate text-center"><span class="st-' . $item['status'] . ' st-' . $item['status'] . '">' . $this->lang->line(ucwords($item['status'])) . '</span></td><td class="text-truncate text-center">' . dateformat($item['invoice_date']) . '</td>
                                <td class="text-truncate text-right">' . number_format($item['total'],2) . '</td>
                            </tr>';
                        }
                        ?>
                    ...
                    <table class="table table-striped table-bordered zero-configuration dataTable" >
                        ...
                        foreach ($tasks as $row) {
                            ...
                            echo ' <tr>
                                ...
                                <td class="text-truncate"><span id="st' . $t . '" class="task_' . $row['status'] . '">' . $row['status'] . '</span></td>
                            </tr>';
            ...
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    ...
                    foreach ($stock as $item) {
                        echo '<li class="list-group-item"><span class="btn btn-sm badge-danger float-xs-right">' . +$item['onhand_quantity'] . ' ' . $item['unit'] . '</span> <a href="' . base_url() . 'products/edit?id=' . $item['product_code'] . '">' . $item['product_name'] . '  </a><small class="purple"> <i class="ft-map-pin"></i> ' . $item['product_name'] . '</small>
                                </li>';
                    } ?>
