        ...
        <div class="card-header border-bottom">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line('Product Categories') ?></li>
                </ol>
            </nav>
            <h4 class="card-title"><?= $this->lang->line('Product Categories') . ' ' . $this->lang->line('Graphical Reports') ?></h4>
                ...
                <form id="chart_custom">
                    ...
                    <div id="custom_c" style="display: none ">
                        <div class="form-row">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-2 mb-1">
                                <fieldset class="form-group1"><span class="mt-2"><br></span>
