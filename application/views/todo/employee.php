<div class="card card-block">
    ...
    <div class="card-body">
        ...
        <p>&nbsp;</p>
        <table id="todotable" class="table table-striped table-bordered zero-configuration" style="width:100%;">
            <thead>
            <tr>
                <th>#</th>
            ...
            <div class="modal-body">
                <form id="form_model">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-default btn-crud"
                                data-dismiss="modal"><?php echo $this->lang->line('Close'); ?></button>
                        <input type="hidden" id="action-url" value="manager/set_task">
                        <button type="button" class="btn btn-primary btn-crud"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close btn-crud" data-dismiss="modal" aria-hidden="true" >&times;</button>
            </div>
