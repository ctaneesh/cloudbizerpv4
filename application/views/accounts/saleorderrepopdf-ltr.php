...
<div class="invoice-box inset" >
    ...
    <thead>
        <tr>
            <td> <strong>Material request to warehouse</strong><br><strong>Salesorder No : #<?= $invocienoId?></strong></td>
            <td> </td>
        </tr>
        </thead>
        <tbody>
    ...
    <table cellpadding="0" cellspacing="0" class="plist maintable">
        ...
        <tr>
            ...
            <td style="font-size: 12px;" with="50%"><strong>Qty Picked</strong></td>
       ...
       $count=1;
        ...
        foreach ($products as $row) {
            ...
            echo '<tr class="itemx" style="font-size: 14px;"><td>' . $count . '</td><td>' . $row['product'] . '</td><td>' . $row['qty'] . '</td><td>' . $row['qty'] . '</td><td> Code : #' . $row['code'] . '<br>Description : ' . $row['product_des'] .'<br>Note :' . $row['notes'] .'</td><td></tr>';
            $count=$count+1;;
        }
        ?>
