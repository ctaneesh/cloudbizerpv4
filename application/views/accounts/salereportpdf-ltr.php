...
<?php   //echo "<pre>"; print_r($_SESSION); die(); ?>
    <table>
        <tr>
            ...
            <?php $imgUrl="".base_url()."userfiles/company/company-logo.jpg";?>
                <img src='<?php echo $imgUrl; ?>' style="max-width:260px;">
            </td>
            <td>
    ...
    <table class="plist" cellpadding="0" cellspacing="0" class="maintable">
        ...
        foreach ($list as $row) {
            ...
            $grandTotal += floatval(str_replace(',', '', $row['amount']));
            $grandqty= $grandqty+$row['qty'];
            $granddiscount=$granddiscount+$row['discount'];
            // $totalTax=$totalTax+$row['tax'];
            echo '<tr class="item"><td>' . $row['date'] . '</td><td>' . $row['name'] . '</td><td>' . $row['product'] . '</td><td style="text-align:center;">' . $row['qty'] . '</td><td style="text-align:right;">' . $row['discount'] . '</td><td style="text-align:right;">' . $row['amount'] . '</td></tr>';
        ...
        <tr>
            ...
            <td></td>
            <td></td>
            <td style="text-align:center;"><strong><?php echo $grandqty;?></strong></td>
            <td style="text-align:right;"><strong><?php echo $granddiscount;?></strong></td>
    ...
    <br>
    <div class="sign" style="text-align:right;">Authorized person<br>
        <?php
        ...
        echo '<div class="sign2">(' . $employee['name'] . ')';
     ?>
    </div>
    <!-- <div class="sign1"></div>
    <div class="sign2"></div>
