                ...
                <div class="table-container">
                    <table id="acctable" class="table table-striped table-bordered zero-configuration" cellspacing="0" width="100%">
                        ...
                        foreach ($accounts as $row) {
                            ...
                            <td>$balance</td>
                            <td>$type</td>
                            <td><a href='" . base_url("accounts/edit?id=$aid") . "' class='btn btn-secondary btn-sm' title='Edit'><i class='fa fa-pencil'></i></a>&nbsp;<a href='#' data-object-id='" . $aid . "' class='btn btn-secondary btn-sm delete-object' title='Delete'><i class='fa fa-trash'></i></a></td></tr>";
                            $i++;
                        }
                        ?>
                        </tbody>
