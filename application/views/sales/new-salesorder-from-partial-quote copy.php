        ...
        <div class="card-header border-bottom">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line('Sales Order Landing') ?></li>
                </ol>
            </nav>
            ...
            <div class="card-body">
                    <div class="row">
                        ...
                        <?php 
                           if($convertedflg=='2')
                           { ?>
                                <button class="btn btn-primary" id="create_salesorder" type="button">Create New Sales order</button>
                           <?php } ?>
                        </div>
                        </div>
                        ...
                        <div id="saman-row">
                            ...
                            <table id="histable"
                                ...
                                <thead>
                                    <tr class="item_header bg-gradient-directional-blue white">
                                        <th width="25%" class="text-center1 pl-1">Item Name & No.</th>
                                        ...
                                        <th width="7%" class="text-center">Quote</th>
                                        <th width="7%" class="text-right">Quote Price</th>
                                        <th width="9%" class="text-center">Sales Order</th>
                         ...
                         <?php 
                           ...
                           foreach ($productdata as $row) {
                                 ...
                                 if(!empty($salesorders)){
                                    ...
                                    foreach ($salesorders[$pid][$quote_id] as $sdata) {
                                       ...
                                       if($pid==$sdata['salesprdid'])
                                       {
                                          ...
                                          $salesurl =  '<a href="' . base_url("quote/salesorders?id=$salesorderid") . '"   title="Sales order" target="_blank">'.($salesordernumber).'</a>';
                                          ...
                                          if($sdata['convertedstatus']==0 && $completed_status==1){
                                            $editbtn = '<button onclick="saleorderedit('.$salesorderid.',\''.$salesordernumber.'\')" type="button" class="btn btn-sm btn-link" title="Edit" style="padding:0 5px;"><i class="fa fa-edit"></i></button>&nbsp;';
                                          }
                                          else{
                                            $editbtn = "";
                                          }
                                          ...
                                          $salestotal .= "<td style='text-align:right; padding-top:0px;padding-right:0px;border:none; border-right:none !important;'><strong>";
                                          $salestotal .= $sdata['subtotal'].'<br><br>';
                                          $salestotal .= "</strong></td>";
                                          $salestotal .= "</tr>";

                                          $salesdiscountdet .= "<tr style='background:none !important;'>";
                                          $salesdiscountdet .= "<td style='text-align:right; padding-right:0px;padding-top:0px;border:none; border-right:none !important;border-bottom:1px solid #ccc;border-radius:0px'>";
                                          $salesdiscountdet .= "<div class='text-center'>";
                                          ...
                                          $unitprice .= "<td style='padding:0px; text-align:right; padding-right:0px;border:none; border-right:none !important;'><strong>";
                                          $unitprice .= $unitcost.'<br><br><br>';
                                          $unitprice .= "</strong></td>";
                                          $unitprice .= "</tr>";
                                       }                                  
                                    }   
                              ...
                              //discount section 
                              echo "<td class='text-right'><table class='table no-border table-striped table-bordered zero-configuration dataTable' style='background:none !important;border:none !important;'>";                             
                            ...
                            //   }
                            $editbtn = "";
                              echo '<td class="text-left"><input type="hidden" name="pid[]" value="'.$row["productid"].'" id="pid-' . $i . '">'.$editbtn.'<button onclick="producthistory('.$i.')" type="button" class="btn btn-sm btn-secondary producthis"  title="History"><i class="fa fa-history"></i></button>&nbsp;<button onclick="single_product_details(' . $i . ')" type="button" class="btn btn-sm btn-secondary"  title="Details"><i class="fa fa-info"></i></button></td>';
                    ...
                    <div class="modal-body">
                            <div class="form-group row">
                                ...
                                <div class="col-12 row mt-3">
                                    ...
                                    <div class="col-2"> <span id="discs" class="lightMode d-none1">0</span></div>
                                    ...
                                    <div class="col-12 text-right mt-2">
                                            <input type="submit" class="btn btn-lg btn-secondary sub-btn" value="<?php echo $this->lang->line("Save As Draft");?>" id="saleorder-draft-btn" data-loading-text="Dtaft...">&nbsp;
                                            <input type="submit" id="new-saleorder-btn" class="btn btn-lg btn-primary margin-bottom"
    ...
    $('#new-saleorder-btn').on('click', function(e) {
        ...
        if ($("#data_form").valid()) {
            ...
            Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: baseurl + 'quote/salesorder_sub_action_old', 
