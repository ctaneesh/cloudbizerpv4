                ...
                <form method="post" id="data_form">
                    <div class="row">
                        ...
                        <div class="title-action">                         
                            ...
                            <button class="btn btn-large btn-success mb-1" title="purchase Order" id="purchaseOrderBtn" type="button"><span class="fa fa-retweet"></span> <?php echo $this->lang->line('Add to purchase Order') ?> </button>

                            <a href="" class="btn btn-primary mb-1"><i
                                        class="fa fa-book"></i> <?php echo $this->lang->line('Packing List') ?> </a>
                            <a href="javascript:void(0)" class="btn btn-warning mb-1" id="MaterialReport"><i
                                        class="fa fa-book"></i> <?php echo $this->lang->line('Material Request Report') ?> </a>

                            <button class="btn btn-primary mb-1" type="button" name="convertedInvoiceBtn" id="convertedInvoiceBtn">Convert to invoice</button>
                            ...
                            <div id="customerpanel" class="inner-cmp-pnl">
                                <div class="form-group row">
                                    <div class="fcol-sm-12">
                                        <h3 class="title">
                                            Order To <a href='#' class="btn btn-primary btn-sm rounded"
                                                       data-toggle="modal"
                            ...
                            <div class="col-sm-6 cmp-pnl">
                                <div class="inner-cmp-pnl">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12"><h3 class="title">Sales Order Properties</h3></div>

                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6"><label for="invocieno" class="caption">Sales Order
                                                Number</label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6"><label for="invociedate" class="caption">Sales Order
                                                Date</label>
                                        ...
                                        <div class="col-sm-6"><label for="invocieduedate" class="caption">Sales Order
                                                Validity</label>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <label for="toAddInfo" class="caption">Sales Order Note</label>
                                            <textarea class="form-control" name="notes" id="salenote"
                        ...
                        <td class="text-center"><button type="button" data-rowid="' . $i . '" class="btn btn-danger removeProd" title="Remove"> <i class="fa fa-minus-square"></i> </button>
                        </td>
                        ...
                        <input type="hidden" class="pdIn" name="pid[]" id="pid-' . $i . '" value="' . $row['pid'] . '">
                         <input type="hidden" name="unit[]" id="unit-' . $i . '" value="' . $row['unit'] . '">  <input type="hidden" name="hsn[]" id="unit-' . $i . '" value="' . $row['code'] . '">
                    </tr><tr class="desc_p"><td colspan="10"><textarea id="dpid-' . $i . '" class="form-control" name="product_description[]" placeholder="Enter Product description" autocomplete="off">' . $row['product_des'] . '</textarea><br></td></tr>';
                                    $i++;
                                } ?>
                                <tr class="last-item-row sub_c">
                                    <td class="add-row">
                                        <button type="button" class="btn btn-success" id="addproduct_quoteedit">
                                ...
                                <tr class="sub_c" style="display: table-row;">
                                    ...
                                    <td align="right" colspan="6"><input type="submit" class="btn btn-primary sub-btn"
                                                                         value="Update"
                                                                         id="submit-data"
...
$('#MaterialReport').click(function () {
    var selectedProducts = [];
        ...
        var form = $('<form action="<?php echo site_url('pos_invoices/salesOrderexportpdf')?>" method="POST"></form>');
