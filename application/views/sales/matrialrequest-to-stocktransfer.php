    ...
    <div class="card">
        ...
        <div class="card-header border-bottom">
             <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('Materialrequest') ?>"><?php echo $this->lang->line('Matrial Requests'); ?></a></li>
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line('Transfer Items'); ?></li>
                </ol>
            </nav>
            <h4 class="card-title"><?php echo $this->lang->line('Transfer Items') ?></h4>            
        ...
        <div  class="card-body">
           <form  method="post" id="data_form">
             <input type="hidden" id="action-url" name="actionurl" value="Materialrequest/stock_transfer_submit">
                <div class="table-scroll">
                    ...
                    <table class="table table-striped table-bordered zero-configuration dataTable">
                        ...
                        <tr class="item_header bg-gradient-directional-blue white">
                            ...
                            <th class="pl-14"><?php echo $this->lang->line('On Hand Qty') ?></th>
                            <th class="pl-14"><?php echo $this->lang->line('Requested Qty') ?></th>
                            <th class="text-center"><?php echo $this->lang->line('Transfer Qty') ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php 
                        if(!empty($requestdata))
                        {
                            ...
                            echo '<td>
                                <input type="text" class="form-control ui-autocomplete-input responsive-width-elements" name="product_unit[]" value="'.$row['unit'].'" readonly>
                                </td>';
                            echo '<td>
                            ...
                            echo '<td>
                                <input type="text" class="form-control ui-autocomplete-input" name="onhand_qty[]" value="'.$row['onhand_qty'].'" readonly>
                                </td>';
                            echo '<td>
                                <input type="text" class="form-control ui-autocomplete-input" name="requested_qty[]" value="'.$row['requested_qty'].'" readonly>
                                </td>';
                            echo '<td>
                                <input type="text" class="form-control ui-autocomplete-input" name="transfer_qty[]" >
                                </td>';
                            echo '</tr>';
                                $i++;
                            }
                        ...
                        <tr class="sub_c" style="display: table-row;">
                            ...
                            <td align="right" colspan="7" class="no-border">
                                <input type="submit" class="btn btn-lg btn-primary sub-btn" value="<?php echo $this->lang->line('Transfer Items') ?>" id="submit-btn" data-loading-text="Creating...">
...
function selectedProductList(){
    ...
    $("#submit-btn").on("click", function (e) {
        ...
        if (!hasProductId) {
            Swal.fire({
                icon: 'error',
                title: 'Missing Transfer Quantity',
                text: 'Please enter at least one transfer quantity before submitting.',
            });
        ...
        if ($("#data_form").valid()) {
            ...
            Swal.fire({
               title: "Are you sure?",
               text: "Do you want to tranfer these items?",
               icon: "question",
               ...
               if (result.isConfirmed) {  
                    $.ajax({
                        type: 'POST',
                        url: baseurl + 'Materialrequest/stock_transfer_submit',
                        data: formData,
                        contentType: false,
                        processData: false,
                        dataType: "json",
