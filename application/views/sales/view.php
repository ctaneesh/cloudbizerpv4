            ...
            <div id="invoice-template" class="card-body">
                <div class="row wrapper white-bg page-heading">
                    <div class="col-lg-12">
                        ...
                        $editurl = base_url('quote/salesorders?id='.$invoice['iid']);
                        $lists = base_url('SalesOrders/');
                        ?>
                        <div class="title-action">
                            <!-- <a href='<?php echo $lists; ?>' class="btn btn-primary mb-1"><i class="fa fa-pencil"></i> <?php echo $this->lang->line('Back to Salesorder List') ?> </a> -->
                            <a href="<?php echo $editurl; ?>" class="btn btn-secondary btn-sm mb-1"><i class="fa fa-pencil"></i> <?php echo $this->lang->line('Edit SalesOrder') ?> </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-sm-12 text-xs-center text-md-right">
                        ...
                        <p class="pb-1"> <?php echo prefix(1) . $invoice['tid'] . '</p>
                            <p class="pb-1">' . $this->lang->line('Reference') . ':' . $invoice['refer'] . '</p>'; ?>
                             <p class="pb-1"><?php echo $this->lang->line('Status') ?> : <u><strong
                                    ...
                                    foreach ($products as $row) {
                                        ...
                                        if($row['qty']>0){
                                            ...
                                            echo '<td>' . amountExchange($row['totaltax'], 0, $this->aauth->get_user()->loc) . ' (' . amountFormat_s($row['tax']) . '%)</td>';
                                                echo '<td>' . amountExchange($row['totaldiscount'], 0, $this->aauth->get_user()->loc) . ' (' . amountFormat_s($row['discount']) . $this->lang->line($invoice['format_discount']) . ')</td>';
                ...
                <div class="card">
                    ...
                    <div class="row col-lg-4 col-md-6 col-sm-12 col-xs-12">
