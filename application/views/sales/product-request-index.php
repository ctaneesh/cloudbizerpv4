<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title"><?php echo $this->lang->line('Buy Requests') ?>
                <a href="<?php echo base_url('Productrequest/add') ?>" class="btn btn-crud btn-primary btn-sm"> <?php echo $this->lang->line('Add new') ?> </a> 
                <div class="btn-group mt-1">
                    <button type="button" class="btn btn-crud btn-sm btn-secondary dropdown-toggle mb-1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-exchange"></i> Convert</button>
                    <div class="dropdown-menu">
                        <a href="<?php echo base_url('Productrequest/purchase_request_to_quote') ?>"  class="dropdown-item mb-1" title="<?php echo $this->lang->line('Quote')."(".$this->lang->line('Supplier').")"; ?>" target="_blank">
                            <?php echo $this->lang->line('Quote')."(".$this->lang->line('Supplier').")"; ?> 
                        </a>
                        <div class="dropdown-divider"></div>
                        <a href="<?php echo base_url('Productrequest/purchase_request_to_purchase_order') ?>"  class="dropdown-item mb-1" title="<?php echo $this->lang->line('Purchase Order')."(".$this->lang->line('Supplier').")";  ?>" target="_blank">
                        <?php echo $this->lang->line('Purchase Order')."(".$this->lang->line('Supplier').")";  ?>
                        </a>
                    </div>
                </div>
            </h4>
            ...
            <div class="card-body">
                ...
                <div class="table-container">
                    <table id="invoices" class="table table-striped table-bordered zero-configuration" style="width:100%;">
                        ...
                        <th  style="width:50px !important;"><?php echo $this->lang->line('Quantity') ?></th>
                        <th><?php echo $this->lang->line('Requested By') ?></th>
                        ...
                        <th><?php echo $this->lang->line('Expected By') ?></th>
...
<script type="text/javascript">
    ...
    function draw_data(start_date = '', end_date = '') {
        $('#invoices').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('Productrequest/ajax_list')?>",
                "type": "POST",
                 'data': {
            ...
            "columnDefs": [
            {
                ...
                "render": function (data, type, full, meta) {
                    var requestID = full[10];  // Assuming product_name is in the second column
                    var value = full[9];
                    
                    return '<label style="width:100px !important;"><input type="checkbox" class="select-checkbox" value="' + value + '"><span style="padding-left:4px; font-size:16px; font-weight:500;">#' + requestID + '</span></label>';
                },
                checkboxes: {
                    selectRow: true
                }
