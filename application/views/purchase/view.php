   ...
   <div class="card">
      <div class="card-header border-bottom">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line('Purchase Order')." #".$invoice['tid']; ?></li>
         </ol>
         <div class="row">
         ...
         <div id="invoice-template" class="card-body">
            <div class="row wrapper white-bg page-heading">
               <div class="col-lg-7">
                  ...
                  <div class="title-action">
                     ...
                     ?>
                     <a href="<?php echo 'edit?id=' . $invoice['iid']; ?>" class="btn btn-sm btn-secondary <?=$disabled?>"><i
                     ...
                     <a href="#part_payment" data-toggle="modal" data-remote="false" data-type="reminder"
                        class="btn btn-sm  btn-secondary  <?php echo $approvedcls; ?>" title="Partial Payment"><span class="fa fa-money"></span> <?php echo $this->lang->line('Make Payment') ?> </a>
                     <div class="btn-group">
                        <button type="button" class="btn btn-sm btn-secondary dropdown-toggle <?php echo $approvedcls; ?>" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu"><a href="#sendEmail" data-toggle="modal"
                           data-remote="false" class="dropdown-item sendbill <?php echo $approvedcls; ?>"
                           data-type="purchase"  ><?php echo $this->lang->line('Purchase Request') ?></a>
                        </div>
                     </div>
                     <div class="btn-group">
                        <button type="button" class="btn btn-sm btn-secondary dropdown-toggle <?php echo $approvedcls; ?>"
                     ...
                     <a href="#pop_model" data-toggle="modal" data-remote="false"
                        class="btn btn-sm btn-secondary <?php echo $approvedcls; ?>" title="Change Status"
                        ><span class="fa fa-retweet"></span> <?php echo $this->lang->line('Change Status') ?></a>
                     <a href="#cancel-bill" class="btn btn-sm btn-secondary <?php echo $approvedcls; ?>" id="cancel-bill_p"><i
                        class="fa fa-minus-circle"> </i> <?php echo $this->lang->line('Cancel') ?>
                     </a>
                     <a  class="btn btn-sm btn-secondary"  target="_blank" href="<?= base_url('Invoices/costing?pid=' . $invoice['iid'] . '&token=' . $validtoken); ?>"><?php echo $this->lang->line('Purchase Receipt') ?></a>
                  </div>
                  <?php
                     if ($invoice['multi'] > 0) {
               ...
               <div class="col-lg-5 col-md-5 col-sm-12 text-lg-right text-md-right text-sm-left">
                     <a href="<?php echo $link; ?>" class="btn btn-sm btn-secondary <?php echo $approvedcls; ?>"  target="_blank"><i
                        class="fa fa-globe"></i> <?php echo $this->lang->line('Public Preview') ?>
                     </a>
                     <div class="btn-group ">
                            <button type="button" class="btn btn-sm btn-secondary btn-min-width dropdown-toggle <?php echo $approvedcls; ?>"
            ...
            <div id="invoice-company-details" class="row mt-2">
               ...
               <div class="col-md-6 col-sm-12 text-xs-center text-md-right">
                  <p class=""> <?php echo prefix(2) . $invoice['tid'] . '</p>
                  ...
                  <ul class="px-0 list-unstyled">
                     <li><?php echo $this->lang->line('Gross Amount') ?>(<?php echo $this->config->item('currency') ?>) : 
                        <span class="lead text-bold-800"><?php echo $invoice['total']; ?></span>
                     </li>
                  </ul>
               </div>
            </div>
            ...
            <div id="invoice-customer-details" class="row">
               ...
               <div class="col-md-9 col-sm-12 text-xs-left text-md-left">
                  <ul class="px-0 list-unstyled">
               ...
               <div class="col-md-3 col-sm-12 text-md-right">
                  <?php echo '<p><span class="text-muted">' . $this->lang->line('Currency') . ' :</span> ' .$currency['code'] . '</p><p><span class="text-muted">' . $this->lang->line('Doc Type') . ' :</span> ' .$invoice['doc_type'] . '</p><p><span class="text-muted">' . $this->lang->line('Order Date') . ' :</span> ' . dateformat($invoice['invoicedate']) . '</p> <p><span class="text-muted">' . $this->lang->line('Due Date') . ' :</span> ' . dateformat($invoice['invoiceduedate']) . '</p>  <p><span class="text-muted">' . $this->lang->line('Terms') . ' :</span> ' . $invoice['termtit'] . '</p>';
                     ?>
               </div>
            </div>
            <!--/ Invoice Customer Details -->
                     ...
                     <table class="table table-striped table-bordered zero-configuration dataTable">
                        ...
                        <tbody>
                           <?php $c = 1;
                              ...
                              <th scope="row">' . $c . '</th>                        
                              <td>' . $row['product'] . '</td>                           
                              <td  class="text-right">' . intval($row['price']) . '</td>
                              <td class="text-center">' . intval($row['qty']) ." ". $row['unit'] . '</td>                              
                              <td class="text-right">' .$row['totaldiscount'].'</td>
                        ...
                        <table class="table">
                           <tbody>
                              <tr>
                                 ...
                                 <td class="text-xs-right"> <?php echo $sub_t; ?></td>
                              </tr>
                              <!-- <tr>
                                 <td class="no-border"><?php echo $this->lang->line('TAX') ?>(<?php echo $this->config->item('currency') ?>)</td>
                                 <td class="text-xs-right no-border"><?php echo $invoice['tax']; ?></td>
                              </tr> -->
                              <tr>
                                 <td class="no-border"><?php echo $this->lang->line('Discount') ?>(<?php echo $this->config->item('currency') ?>)</td>
                                 <td class="text-xs-right no-border"><?php echo $invoice['discount']; ?></td>
                              </tr>
                              <!-- <tr>
                                 <td class="no-border"><?php echo $this->lang->line('Shipping') ?>(<?php echo $this->config->item('currency') ?>)</td>
                                 <td class="text-xs-right no-border"><?php echo $invoice['shipping']; ?></td>
                              </tr> -->
                              <tr>
                                 <td class="text-bold-800 no-border"><?php echo $this->lang->line('Total') ?>(<?php echo $this->config->item('currency') ?>)</td>
                                 <td class="text-bold-800 text-xs-right no-border"> <?php echo $invoice['total']; ?></td>
                              </tr>
                              <!-- <tr>
                                 <td class="no-border"><?php echo $this->lang->line('Payment Made') ?></td>
                                 <td class="text-xs-right no-border">
                                    (-) <?php echo ' <span id="paymade">' . amountExchange($invoice['pamnt']); ?></span>
                                 </td>
                              </tr> -->
                              <tr class="bg-grey bg-lighten-4">
                                 <td class="text-bold-800"><?php echo $this->lang->line('Balance Due') ?>(<?php echo $this->config->item('currency') ?>)</td>
            ...
            <div class="card1">
               ...
               <!-- <span class="btn btn-outline-light fileinput-button">
