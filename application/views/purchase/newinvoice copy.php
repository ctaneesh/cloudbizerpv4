      ...
      <div class="card-header border-bottom">
         <?php 
            ...
            <div class="row">
               ...
               <!-- Array ( [0] => Array ( [first_level_approval] => No [second_level_approval] => No [third_level_approval] => No [user_id] => 28 [module_id] => 500 ) ) -->
                     ...
                     <tbody>
                        ...
                        <tr class="sub_c" style="display: table-row;">
                           ...
                           <td colspan="5" class="no-border">
                              ...
                              <?php }
                              $approval_permission = ($your_approval_level[0]['first_level_approval']=="Yes" && $invoice['approval_flag'] != 1) ?"":"d-none";
                              $approval_permission_send = (($your_approval_level[0]['first_level_approval']!="Yes") && $invoice['approval_flag'] != 1) ?"d-none":"";
                              $approval_permission_enabled = (($your_approval_level[0]['first_level_approval']=="Yes") && $invoice['approval_flag'] != 1) ?"disable-class":"";
                              $approval_cancel_permission = ($your_approval_level[0]['first_level_approval']=="Yes" && $invoice['approval_flag'] == 1) ?"":"d-none";
                              ?>
                           ...
                           <td align="right" colspan="8" class="no-border">
                              ...
                              { ?>  
                               <input type="submit" class="btn btn-crud btn-lg btn-secondary sub-btn purchase-approve-btn <?=$accpetthenhide?>" value="<?php echo $this->lang->line('Update') ?>">
                                 <!-- <button type="button" class="btn btn-crud btn-lg btn-primary <?=$assign_personcls?> <?=$generatebtn?> <?=$accpetthenhide?> <?=$acceptsendbtncls?>" id="po-accept-btn"><?php echo $this->lang->line('Accept & Send') ?></button>&nbsp; -->
                              <?php 
                              } 
                              
                              ?>

                              <input type="submit" class="btn btn-crud btn-lg btn-secondary first-level-approve-btn <?=$approval_permission?>"  value="<?php echo $this->lang->line('Approve') ?>" data-loading-text="Creating...">
                              ...
                              <input type="submit" class="btn btn-lg btn-primary purchase-send-btn <?=$accpetthenhide?> <?=$approval_permission_send?> <?=$approval_permission_enabled?>"  value="<?php echo $this->lang->line('Send Purchase Order') ?>">
