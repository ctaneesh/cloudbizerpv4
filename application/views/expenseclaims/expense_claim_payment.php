      ...
      <div class="card-content mt-1">
         ...
         <div id="invoice-template" class="card-body">
            ...
            <form class="payment" name="customerPaymentForm" id="customerPaymentForm" method="POST">
               <div id="invoice-customer-details" class="row">
                  ...
                  <div class="col-md-4 col-sm-12 text-xs-center text-md-left">
                     <input type="hidden" name="supplierid" value="<?=$expense_details['supplierid']?>" id="supplierid">
                        <?php 
                        ...
                        <table class="table table-striped table-bordered zero-configuration dataTable"
                              ...
                              <thead>
                                 <tr>
                                       ...
                                       <th width="10%"><?php echo $this->lang->line("Claim Amount"); ?></th>
                                       <th width="10%"><?php echo $this->lang->line("Paid Amount"); ?></th>
                                       <th width="10%"><?php echo $this->lang->line("Due Amount"); ?></th>
                       ...
                       <!-- ================= type = card ================================= -->
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-12 paymentmethod amountsection d-none">
                           <fieldset class="form-group">
                              ...
                              <input type="number" class="form-control" required placeholder="Payable Amount" name="amount" id="rmpay" value="<?=$balanceamount?>">
                           ...
                           <?php
                              ...
                              foreach ($accountheaders as $parentItem) {
                                 ...
                                 foreach ($accountlists[$coaHeaderId] as $row) {
                                       ...
                                       $acn = $row['acn'];
                                       $selted = "";
                                       if ($default_receivableaccount['acn'] == $acn) {
                                       $selted = 'selected';
                                       }
            ...
            <div class="col-12 text-right">
               <div class="form-group">
                  <input type="hidden" class="form-control required"  name="tid" id="invoiceid" value="<?php echo $expense_details['iid'] ?>">
                  ...
                  <input type="hidden" name="cid" value="<?php echo $expense_details['supplier_id'] ?>">
                  <input type="hidden" name="cname" value="<?php echo $expense_details['supplier'] ?>">
                  
                  <button type="submit" class="btn btn-lg btn-primary" id="expenseclaim_payment_btn"><?php echo $this->lang->line('Make Payment'); ?></button>
      ...
      if (parseFloat(recievedamt) <  1) {       
        ...
        Swal.fire({
                  ...
                  if (result.isConfirmed) {
                     $.ajax({
                           url: baseurl + "transactions/payexpenseclaim",
                           type: 'POST',
                           data: formData,
                           contentType: false,
                           processData: false,
