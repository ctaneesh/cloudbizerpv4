        ...
        <form method="post" id="data_form" class="form-horizontal">
            ...
            <div class="form-group row">                
                ...
                <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12">
                    ...
                    <input type="date" placeholder="Enter date" value="<?=$transaction_details['trans_date']?>" class="form-control margin-bottom required" name="trans_date" id="trans_date">
                </div>
                <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 mt-2 submit-section">
                    ...
                    <input type="submit" id="transaction-btn" class="btn btn-lg btn-primary margin-bottom"
        ...
        if ($("#data_form").valid()) {                
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: baseurl + 'bankingtransactions/banktransaction_update_action', // Replace with your server endpoint
                        type: 'POST',
                        data: formData,
                        contentType: false, 
                        processData: false,
                        success: function(response) {
                            ...
                            if(response.status=='Error')
                            {
                                ...
                                window.location.href = baseurl + 'accounts/add';
                            }
