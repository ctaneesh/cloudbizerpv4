...
<div class="invoice-box inset" >
    ...
    <table>
        <thead>
            <tr>
                <td> <strong>Aged Payables Report </td>
    ...
    <table>
        <thead>
            <tr>
                <th style="font-size: 12px;text-align:center;"><?php echo $this->lang->line('Supplier') ?></th>
                <th style="font-size: 12px;text-align:center;"><?php echo $this->lang->line('Created Date') ?></th>
                ...
                <div class="collapse" id="<?=$customerId?>">
                    ...
                    foreach ($paymentlist as $key => $list) {
                        if (isset($paymentlist[$key][$customerId])) {
                            ...
                            $subtotal = $list[$customerId]['total'];
                            $grand_total += $list[$customerId]['total'];
                            $paid_total += $list[$customerId]['pamnt'];
                            ...
                            <tr>
                                ...
                                <td style="font-size: 12px;text-align:right;"><?=number_format($list[$customerId]['pamnt'],2)?></td>
