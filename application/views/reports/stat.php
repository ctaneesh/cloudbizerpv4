        ...
        <div class="card-header border-bottom">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line('Company Statistics'); ?></li>
                </ol>
            </nav>
            <h5><?php echo $this->lang->line('Company Statistics') ?> <a class="btn btn-purple" href="<?php echo base_url() ?>reports/refresh_data"><i class="fa fa-refresh"></i></a></h5>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration dataTable">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-right"><?php echo $this->lang->line('Expenses') ?></th>
                                            <th class="text-right"><?php echo $this->lang->line('Sales') ?></th>
                                            <th class="text-center"><?php echo $this->lang->line('Invoices') ?></th>
                                            <th class="text-center"><?php echo $this->lang->line('sold') . $this->lang->line('products') ?></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                        ...
                                        foreach ($stat as $item) {
                                            ...
                                            echo '<tr>
                                                ...
                                                <td class="text-truncate text-right"> ' . $item['income'] . '</td>
                                            
                                                <td class="text-truncate text-right">' . $item['expense'] . '</td>
                                                <td class="text-truncate text-right">' . $item['sales'] . '</td>
                                                <td class="text-truncate text-center">' . $item['invoices'] . '</td>
                                                <td class="text-truncate text-center">' . intval($item['items']) . '</td>
