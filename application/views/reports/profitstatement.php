        ...
        <div class="card-header border-bottom">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line('Profit'); ?></li>
                </ol>
            </nav>
            
            <h4 class="card-title"><?php echo $this->lang->line('Profit') . ' ' . $this->lang->line('Data') ?></h4>
            <hr>
