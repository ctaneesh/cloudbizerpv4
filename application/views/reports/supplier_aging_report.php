        ...
        <div class="card-header border-bottom">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><?php echo $this->lang->line('Aged Payables'); ?></li>
                </ol>
            </nav>
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12">
                    <h4 class="card-title"><?php echo $this->lang->line('Aged Payables'); ?></h4>
                    <p>As of the Date - <b><?=date('d-M-Y')?></b><br>Amount the company owes to vendors</p>
                </div>
                ...
                <button class="btn btn-secondary btn-sm mt-1">
                    ...
                    <a href="<?php echo base_url(); ?>reports/pay_to_supplier_report" class="btn btn-secondary btn-sm mt-1 btn-crud" target="_blank">PDF</a>
                    <a href="<?php echo base_url(); ?>reports/export_to_excel_for_aged_payable" class="btn btn-secondary btn-sm mt-1 btn-crud" target="_blank">Excel</a>
                </div>
            </div>
                ...
                <table class="agingtable table table-striped table-bordered zero-configuration dataTable">
                        <thead>
                            <tr class="item_header bg-gradient-directional-blue white">
                                <th width="22%" class="text-center1 pl-1"><?php echo $this->lang->line('Supplier') ?></th>
                                <th width="5%" class="text-center"><?php echo $this->lang->line('Created Date') ?></th>
                                ...
                                <div class="collapseitems" id="<?=$customerId?>">
                                    ...
                                    foreach ($paymentlist as $key => $list) {
                                        if (isset($paymentlist[$key][$customerId])) {
                                            ...
                                            $invoicetid = $list[$customerId]['purchase_number'];
                                            ...
                                            ?>
                                            <tr class="collapseitems <?=$customerId?>">
                                                <td><?=$invoicetid?></td>
