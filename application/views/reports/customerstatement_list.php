        ...
        <div class="card-header border-bottom">            
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('reports/customerstatement') ?>"><?php echo $this->lang->line('Customer') . ' ' . $this->lang->line('Account Statement') ?></a></li>
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line('Account Statement') ?></li>
                </ol>
            </nav>
            <h4><?php echo $this->lang->line('Customer') ?> : <?php echo $filter[5] ?></h4>
