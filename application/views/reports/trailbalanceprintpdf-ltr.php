...
<table>
    ...
    <table>
        <thead>
            <tr>
            <td> <strong>Trail Balance Report</td>
    ...
    <?php 
                        if($trail_account_headers)
                        {
                            ...
                            foreach ($trail_account_headers as $value) {
                                echo '<table class="report-content-table">';
                                echo '<thead>
                                            <tr>
                                ...
                                foreach ($trail_account_details[$value['coa_header_id']] as $key => $row) {
                                    ...
                                    echo '<tbody>
                                                <tr>
                                                    <td style="padding: 10px;">'.$row['holder'].'</td>
                                                    <td style="padding: 10px; text-align: right;font-weight: 400;">'.number_format($debit,2).'</td>
                                                    <td style="padding: 10px; text-align: right;font-weight: 400;">'.number_format($credit,2).'</td>
                                                </tr>
                                            </tbody>';
                                }
                                echo '</table>';
                    ...
                    <table class="report-content-table">
                       <tfoot>
                            <tr>
                                ...
                                <th style="padding: 10px; text-align: right;font-weight: bold;"><?=number_format($debit_total,2)?></th>
                                <th style="padding: 10px; text-align: right;font-weight: bold;"><?=number_format($credit_total,2)?></th>
                            </tr>
                        </tfoot>
                    </table>
    <?php
