    ...
    <div class="card">
        <div class="card-header border-bottom">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line('Quotes') ?></li>
                </ol>
            </nav>
            <h4 class="card-title"><?php echo $this->lang->line('Quotes') ?> <a
                    href="<?php echo base_url('quote/create') ?>" class="btn btn-primary btn-sm rounded">
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                ...
                <div class="whole_filter_section filter_list_section mb-1">
                    <div class="row mb-2">
                        ...
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-12 filterall">
                            <label for="filter_category" class='col-form-label'><?php echo $this->lang->line('Quote Validity') ?></label>
                ...
                ?>
                    <div class="responsive-text-right tablet-scroll">
                        ...
                        <div class="btn-quick-view filter-group">
                            <button type="button" class="btn btn-outline-secondary navsearch" id="today" onclick="today()"><div class="filter-day-count  d-flex justify-content-between"><div><?php echo $this->lang->line('Today'); ?></div><div id="daily_count"><?php echo $counts->daily_count; ?></div></div>
                            ...
                            <button type="button" class="btn btn-outline-secondary navsearch" id="week" onclick="week()"><div class="filter-day-count  d-flex justify-content-between"><?php echo $this->lang->line('Week'); ?>
                            <div id="weekly_count"><?php echo $counts->weekly_count; ?></div></div>
                            ...
                            <button type="button" class="btn btn-outline-secondary navsearch" id="month" onclick="month()"><div class="filter-day-count  d-flex justify-content-between"><div><?php echo $this->lang->line('Month'); ?></div><div id="monthly_count"><?php echo $counts->monthly_count; ?></div></div>
                            ...
                            <button type="button" class="btn btn-outline-secondary navsearch" id="quarter" onclick="quarter()"><div class="filter-day-count  d-flex justify-content-between"><div><?php echo $this->lang->line('Quarter'); ?></div><div id="quarterly_count"><?php echo $counts->quarterly_count; ?></div></div>
                            <div class="filter-day-value">
                                <?php   
                            ...
                            <button type="button" class="btn btn-outline-secondary navsearch" id="year" onclick="year()"><div class="filter-day-count  d-flex justify-content-between"><div><?php echo $this->lang->line('Year'); ?></div><div id="yearly_count"><?php echo $counts->yearly_count; ?></div></div>
                ...
                <hr>
                <div class="table-table-scroll3" >
                    <table id="quotes" class="table table-striped table-bordered zero-configuration w-100" >
                        <thead>
                            <tr>
                                ...
                                <th class="text-center"><?php echo $this->lang->line('Quote Validity') ?></th>
                                <th class="text-right"><?php echo $this->lang->line('Total') ?></th>
                                <!-- <th class="text-right"><?php echo $this->lang->line('Internal Reference') ?></th> -->
                                <!-- <th class="text-right"><?php echo $this->lang->line('Customer Reference') ?></th> -->
                                <!-- <th class="no-sort text-center"><?php echo $this->lang->line('Approved By') ?></th>
                                <th class="no-sort text-center"><?php echo $this->lang->line('Approved Date & Time') ?></th> -->
                                <th class="no-sort text-center"><?php echo $this->lang->line('Approval') ?></th>
                                ...
                                <th class="no-sort text-center" ><?php echo $this->lang->line('Sales Order') ?></th>
