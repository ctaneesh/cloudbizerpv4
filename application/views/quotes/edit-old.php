                        ...
                        <div class="col-sm-6 cmp-pnl">
                            <div id="customerpanel" class="inner-cmp-pnl">
                                <div class="form-group row">
                                    ...
                                    <div class="fcol-sm-12" style="margin-top: 4px;   padding-left: 20px;">
                                    <button type="button" id="purchaseOrderBtn" class="btn btn-success btn-sm rounded">Add to purchase Order</button>
                                    </div>
                                </div>
                                <div class="form-group row">
