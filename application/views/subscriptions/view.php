                    ...
                    <div id="invoice-template" class="card-body">
                        ...
                        <div class="">
                            ...
                            if ($invoice['status'] != 'canceled') { ?>
                                ...
                                <a href="<?php echo 'edit?id=' . $invoice['iid']; ?>" class="btn btn-warning mb-1 d-none"><i
                                ...
                                <a href="#part_payment" data-toggle="modal" data-remote="false" data-type="reminder"
                                   class="btn btn-large btn-success mb-1 d-none" title="Partial Payment"
                                ><span class="fa fa-money"></span> <?php echo $this->lang->line('Make Payment') ?> </a>
                                <div class="btn-group">
                                    <button type="button" class="btn btn-secondary dropdown-toggle mb-1"
                            ...
                            <span
                                ...
                                <div class="btn-group ">
                                    <button type="button" class="btn btn-secondary mb-1 btn-min-width dropdown-toggle"
                                ...
                                <a href="<?php echo $link; ?>" class="btn btn-secondary mb-1"><i
                                            class="fa fa-globe"></i> <?php echo $this->lang->line('Preview') ?>
                                </a>

                                <a href="#pop_model" data-toggle="modal" data-remote="false"
                                   class="btn btn-large btn-secondary mb-1" title="Change Status"
                                ...
                                echo '<h2 class="btn btn-secondary btn-danger">' . $this->lang->line('Cancelled') . '</h2>';
                            } ?>
                        </div>
                        ...
                        <div id="invoice-company-details" class="row mt-2">
                            ...
                            <div class="col-md-6 col-sm-12 text-xs-center text-md-right">
                                <h3><?php echo $this->lang->line('Subscription');
                                    echo '</h2><h4><span class="btn-sm st-sub' . $invoice['i_class'] . '">' . $this->lang->line('Sub_' . $invoice['i_class']) . '</span>'; ?></h3>
