                ...
                <div id="invoice-template" class="card-body">
                    <div class="row wrapper white-bg page-heading">
                        ...
                        <div class="col-lg-12">
                            ...
                            if ($invoice['status'] != 'canceled') { ?>
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-right d-none">
                                        <div class="btn-group mt-2">
                                            <button type="button" class="btn btn-crud btn-primary btn-min-width dropdown-toggle"
                                ...
                                echo '<h2 class="btn btn-crud btn-oval btn-danger">' . $this->lang->line('Cancelled') . '</h2>';
                            } ?>
                        </div>
                    </div>
                    ...
                    <div id="invoice-company-details" class="row mt-2">
                        ...
                        <div class="col-md-6 col-sm-12 text-xs-center text-md-right mt-2">
                            <h2><?php echo $this->lang->line('Purchase Order')." #". $invoice['tid'] ?></h2>
                            
                            <?php echo '<p class="pb-1">' . $this->lang->line('Reference') . ':' . $invoice['refer'] . '</p>'; ?>
                            <ul class="px-0 list-unstyled">
                                <li><?php echo $this->lang->line('Gross Amount') ?> <strong><?php echo amountExchange($invoice['total'], $invoice['multi'], $invoice['loc']) ?></strong></li>
                            </ul>
                        </div>
                    ...
                    <div id="invoice-customer-details" class="row pt-2">
                        ...
                        <div class="col-md-4 col-sm-12 text-xs-center text-md-right">
                            <?php echo '<p><span class="text-muted">' . $this->lang->line('Purchase Order Date') . ' :</span> ' . dateformat($invoice['invoicedate']) . '</p> <p><span class="text-muted">' . $this->lang->line('Due Date') . ' :</span> ' . dateformat($invoice['invoiceduedate']) . '</p>';
                            ?>
                        </div>
                    </div>
                    <!--/ Invoice Customer Details -->
                                ...
                                <table class="table table-striped table-bordered zero-configuration dataTable">
                                    ...
                                    <?php
                                        ...
                                        foreach ($products as $row) {
                                            ...
                                            <td>' . intval($row['qty']) . $row['unit'] . '</td>';
                                            // echo '<td>' . $row['totaltax'] . ' (' . amountFormat_s($row['tax']) . '%)</td>';
                                            echo '<td>' .amountFormat_s($row['discount']) .'</td>
                                            <td>' . $row['subtotal'] . '</td>
                                           </tr>';
                                            $c++;
                                        } ?>
                                        ...
                                        foreach ($products as $row) {
                                            ...
                                            // echo '<td>' . $row['totaltax'] . ' (' . amountFormat_s($row['tax']) . '%)</td>';
                                            echo '<td class="text-right">' . number_format($row['discount'],2).'</td>
                                            <td class="text-right">' . number_format($row['subtotal'],2) . '</td>
                                           </tr>';

                                            //erp2024 old one 01-10-2024
                                            // echo '<tr>
                                            //     <th scope="row">' . $c . '</th>
                                            //     <td>' . $row['product'] . '</td>                           
                                            //     <td>' . amountExchange($row['price'], $invoice['multi'], $invoice['loc']) . '</td>
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-bold-800 text-right"> 
                                                ...
                                                echo number_format($invoice['total'],2);
                                                 ?>
                                            </td>
                                        </tr>
                                        <tr class="d-none">
