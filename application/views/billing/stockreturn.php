                ...
                <div id="invoice-template" class="card-body">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                   href="<?php echo 'printstockreturn?id=' . $invoice['iid'] . '&token=' . $token; ?>" target="_blank"><?php echo $this->lang->line('Print') ?></a>
                    ...
                    <div id="invoice-company-details" class="row">
                        <div class="col-md-6 col-sm-12 text-xs-center text-md-left"><p></p>
                            ...
                            <p class="ml-3 mr-3 text-muted"><?php echo $this->lang->line('From') ?></p>
                        ...
                        <div class="col-md-6 col-sm-12 text-xs-center text-md-right mt-2">
                            <h3><?php
                                switch ($invoice['i_class']) {
                                    case 0 :
                                        $type_i = $this->lang->line('Debit Note');
                                        break;
                                    case 1 :
                                        $type_i = $this->lang->line('Debit Note');
                                        break;
                    ...
                    <div id="invoice-customer-details" class="row pt-2">
                        ...
                        <div class="offset-md-3 col-md-3 col-sm-12 text-md-right text-lg-right text-sm-left">
                            <?php echo '<p><span class="text-muted">' . $this->lang->line('Date') . ' :</span> ' . dateformat($invoice['invoicedate']) . '</p>';
                            // echo '<p><span class="text-muted">' . $this->lang->line('Due Date') . ' :</span> ' . dateformat($invoice['invoiceduedate']) . '</p>  <p><span class="text-muted">' . $this->lang->line('Terms') . ' :</span> ' . $invoice['termtit'] . '</p>';
                            ?>
                        </div>
                    </div>
                    <!--/ Invoice Customer Details -->
                    ...
                    <div id="invoice-items-details" class="pt-2">
                                ...
                                <table class="table table-striped table-bordered zero-configuration dataTable">
                                    ...
                                    foreach ($products as $row) {
                                        ...
                                        echo '<tr>
                                            ...
                                            //  echo '<td>' . amountExchange($row['totaldiscount'], $invoice['multi'], $invoice['loc']) . ' (' . amountFormat_s($row['discount']) . $this->lang->line($invoice['format_discount']) . ')</td>';
                        ...
                        <div class="row">
                            <div class="col-md-9 col-sm-12 text-xs-center text-md-left">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <p class="lead d-none"><?php echo $this->lang->line('Payment Status') ?>:
                                            <u><strong id="pstatus"><?php echo $this->lang->line(ucwords($invoice['status'])) ?></strong></u>
                                        </p>
                            ...
                            <div class="col-md-3 col-sm-12">
                                ...
                                <div class="text-xs-center text-lg-right text-md-right text-sm-center">
                    ...
                    <div id="invoice-footer" class="d-none"><p class="lead"><?php echo $this->lang->line('Transactions') ?>:</p>
                        <table class="table table-striped table-bordered zero-configuration dataTable">
                            <thead>
                            <tr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 col-sm-12">
                                ...
                                <h6  class="d-none"><?php echo $this->lang->line('Terms & Condition') ?></h6>
                                <p class="d-none"> <?php
