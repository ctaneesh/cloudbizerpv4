    ...
    <div class="card card-block">
         ...
         <div class="card-header">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><?php echo $this->lang->line('Edit') . ' ' . $this->lang->line('Department') ?></li>
                  
                </ol>
            </nav>
            <h4 class="card-title"><?php echo $this->lang->line('Edit') . ' ' . $this->lang->line('Department') ?></h4>
        ...
        <div class="card card-body">
            ...
            <form method="post" id="data_form" class="form-horizontal">
                ...
                <input type="hidden" name="did" value="<?php echo $department['id'] ?>">


                <div class="form-group row">
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <label class="col-form-label" for="note"><?php echo $this->lang->line('Name') ?><span class="compulsoryfld">*</span></label>
                        <input type="text" placeholder="Department Name" class="form-control margin-bottom b_input required" name="name" value="<?php echo $department['val1'] ?>">
                    </div>
