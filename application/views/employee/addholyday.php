<article class="content">
    <div class="card card-block">
        <div id="notify" class="alert alert-+" style="display:none;">
            ...
            <form method="post" id="data_form" class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                        ...
                        <input type="text" placeholder="Note Title"  class="form-control margin-bottom b_input required" name="note">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 submit-section">
                        <input type="submit" id="submit-data" class="btn btn-crud btn-primary btn-lg margin-bottom"
