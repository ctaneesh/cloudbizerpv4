      ...
      <div class="card-header border-bottom">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line('Delivery Returns'); ?></li>
                </ol>
            </nav>
         <h4 class="card-title"><?php echo $this->lang->line('Delivery Returns') ?></h4>
                ...
                <div class="text-right tablet-scroll">
                    ...
                    <div class="btn-quick-view filter-group">
                        ...
                        <div class="filter-day-value">
                            <?php   
                                    echo " <span title='".$this->lang->line('Created Title')."'> ".$this->lang->line('Filter Created')." : <strong class='filter-created' id='daily_created_count'>". $counts->daily_created_count."</strong></span>";
                                    echo " <span title='".$this->lang->line('Approved Title')."'>".$this->lang->line('Filter Approved')." : <strong class='filter-due' id='daily_draft_count'>".$counts->daily_draft_count."</strong></span>";
                            ?>
                            </div>
                        ...
                        <div class="filter-day-value">
                            <?php   
                                    echo " <span title='".$this->lang->line('Created Title')."'> ".$this->lang->line('Filter Created')." : <strong class='filter-created' id='weekly_created_count'>". $counts->weekly_created_count."</strong></span>";
                                    echo " <span title='".$this->lang->line('Approved Title')."'>".$this->lang->line('Filter Approved')." : <strong class='filter-due' id='weekly_draft_count'>".$counts->weekly_draft_count."</strong></span>";
                            ?>
                            </div>
                        ...
                        <div class="filter-day-value">
                            <?php   
                                    echo " <span title='".$this->lang->line('Created Title')."'> ".$this->lang->line('Filter Created')." : <strong class='filter-created' id='monthly_created_count'>". $counts->monthly_created_count."</strong></span>";
                                    echo " <span title='".$this->lang->line('Approved Title')."'>".$this->lang->line('Filter Approved')." : <strong class='filter-due' id='monthly_draft_count'>".$counts->monthly_draft_count."</strong></span>";
                            ?>
                            </div>
                        ...
                        <div class="filter-day-value">
                            <?php   
                                    echo " <span title='".$this->lang->line('Created Title')."'> ".$this->lang->line('Filter Created')." : <strong class='filter-created' id='quarterly_created_count'>". $counts->quarterly_created_count."</strong></span>";
                                    echo " <span title='".$this->lang->line('Approved Title')."'>".$this->lang->line('Filter Approved')." : <strong class='filter-due' id='quarterly_draft_count'>".$counts->quarterly_draft_count."</strong></span>";
                            ?>
                            </div>
                        ...
                        <div class="filter-day-value">
                            <?php   
                                    echo " <span title='".$this->lang->line('Created Title')."'> ".$this->lang->line('Filter Created')." : <strong class='filter-created' id='yearly_created_count'>". $counts->yearly_created_count."</strong></span>";
                                    echo " <span title='".$this->lang->line('Approved Title')."'>".$this->lang->line('Filter Approved')." : <strong class='filter-due' id='yearly_draft_count'>".$counts->yearly_draft_count."</strong></span>";
                            ?>
                            </div>
            ...
            <div class="table-container">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="text-center"> Delivery Return #</th>
                        ...
                        <th class="text-center"><?php echo $this->lang->line('Is it Invoiced?') ?></th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody>
...
function week() {    
    ...
    // month = ("0" + (date.getMonth() + 1)).slice(-2); // Add leading zero
    // day = ("0" + date.getDate()).slice(-2); // Add leading zero
    // var start_date = year + '-' + month + '-' + day; // Date 7 days ago    
...
function draw_data(start_date = '', end_date = '') {
    $('#DeliveryNotes').DataTable({
        ...
        'order': [],
        'ajax': {
            'url': "<?php echo site_url('Deliveryreturn/ajax_list')?>",
            'type': 'POST',
            'data': {
