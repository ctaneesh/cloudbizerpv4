...
<div class="card card-block">
    ...
    <div class="card-body">
        <h5 class="title"> <?php echo $this->lang->line('User Menu Report') ?> </h5>
        <hr>
        <div class="card card-block formborder">
            <form method="post" id="data_form" class="form-horizontal">
                ...
                <div class="tab-content" id="pills-tabContent">
                  ...
                  <div id="printableTable" class="table-scroll">
                    <!-- <input typ="text" id="username" value=""> -->
             
                        <?php
                       
                        echo '<table id="catgtable1" class="table table-striped table-bordered zero-configuration dataTable w-100" cellspacing="0">';
                        // echo '<thead>';
                        // // echo '<tr>';
                                        
                        // // echo '<th  class="text-center"><b>NAME : '.$username.'</b></th>';
                        // // echo '</tr>';
                        // echo '</thead>';
                        ...
                        foreach ($mainarray as $main_menu => $submenu1Array) {
                            ...
                            echo '<tr>';
                            echo '<td><b>'.$main_menu.'</b></td><td></td>';                            
                            echo '</tr>';
                             echo '<tbody>';
                             echo '<tr>';                       
                             echo '<td width="10%" class="text-center1"><b>Main Menu</b></td>';
                             echo '<td width="80%" class="text-center1"><b>Sub Menus</b></td>';
                             echo '</tr>';
                                            ...
                                            if (isset($subarray[$main_menu][$submenu1])) {
                                                ...
                                                foreach ($subarray[$main_menu][$submenu1] as $submenu2 => $submenu2Data) {
                                                    ...
                                                    $mainfunction_checked = (in_array($top_menu_id, $linked_menu_ids)) ? "checked" : "";
                                                      ...
                                                      if($mainfunction_checked=="checked"){
                                                        echo '<tr>';
                                                        echo '<td>'.$submenu1.'/'.$submenu2.'</td>';
                                                      }
                                                   
                                                  //  echo '<ul>';
                                                    // Print functions under submenu2
                                                    $last = end($submenu2Data['functions']);
                                                    echo '<td class="responsive-width1">';
                                                    foreach ($submenu2Data['functions'] as $index => $subFunction) {
                                                        ...
                                                        if($subFunction)
                                                        {
                                                            ...
                                                            if($sbufunction_checked=="checked"){
                                                            echo $subFunction;
                                                            if ($subFunction !== $last) { // Add a comma if it's not the last item
                                                            echo ',  '; 
                                                            echo "&nbsp;&nbsp;";
                                                            }
                                                        }
                                                    ...
                                                    if (isset($lastarray[$main_menu][$submenu1][$submenu2])) {
                                                        ...
                                                        foreach ($lastarray[$main_menu][$submenu1][$submenu2] as $menu_detail => $menuDetailData) {
                                                            ...
                                                            // {
                                                               ...
                                                               if($checked_or_not=="checked"){
                                                               // echo "<input type='hidden' id='".$subpageval."' value='".$linked_or_not."'>";
                                                               echo "&nbsp;&nbsp;";
                                                               echo '<label style="font-size: 13px;" for="'.$menu_detail.'">'.$menu_detail.' -  </label>';
                                                               }
                                                            $last1 = end($menuDetailData['functions']);
                                                            ...
                                                            if($sbufunction_checked=="checked"){ 
                                                               ...
                                                               echo '<label style="font-size: 13px;" for="'.$checkbox_label.'">'.$detailFunction.'</label>';  
                                                               if ($detailFunction !== $last1) { // Add a comma if it's not the last item
                                                                echo ',  '; 
                                                                echo "&nbsp;&nbsp;";
                                                                }
...
var table = $('#catgtable1').DataTable({
    paging: true,
    scrollX: true,
    lengthChange: true,
    searching: true,
    ...
    columnDefs: [
        {
            ...
            orderable: true, // Make the first column orderable
            width: '25%' // Set the width of the first column
        },
        {
            targets: 1, // Second column
            width: '75%' // Set the width of the second column
        }
    ]
});
console.log($('#catgtable1').html());
// // After the DataTable is loaded, modify the dropdown
// var $dropdown = $('select[name="catgtable1_length"]');

// // Check if "20" is already an option
// if ($dropdown.find('option[value="20"]').length === 0) {
//     // Add "20" as an option if it doesn't exist
//     $dropdown.append('<option value="20">20</option>');
// }

// // Set the default selected option to "20"
// $dropdown.val('20').trigger('change'); // Update the dropdown and trigger the change event

// // Optionally, set the page length to 20 after changing the dropdown
...
$('#user_id').on('change', function(e) {
    ...
    {     
        Swal.fire({
            ...
            if (result.isConfirmed) {                    
                window.location.href = baseurl + 'roles/set_permissions_for_the_user1?user=' + user_id;
            } else {           
...
<!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js"></script> -->
    <!-- <script>
        function exportToExcel() {
            ...
            const table = document.getElementById('catgtable1');
