            ...
            <form method="post" id="data_form" class="form-horizontal">
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="btn nav-link" id="pills-profile-tab" data-toggle="pill" data-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false"><?php echo $this->lang->line('Premissions') ?></button>
                    </li>            
                </ul>
                <!-- ======================================== -->
                    ...
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <?php                      
                            ...
                            foreach ($mainarray as $main_menu => $submenu1Array) {
                                    echo '<table class="w-100 mainmodule '.$main_menu.'">';
                                    echo '<tr>';
                                    ...
                                    echo '</tr>';
                                    echo '</table>';
                                    echo '<div class="row permissions '.$main_menu.'">';
                                    ...
                                    // Check for submenu2 in subarray
                                        ...
                                        if (isset($subarray[$main_menu][$submenu1])) {
                                            ...
                                            foreach ($subarray[$main_menu][$submenu1] as $submenu2 => $submenu2Data) {
                                                ...
                                                //   echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>$submenu2</strong> (Menu ID: $lastMenuId)<br>";
                                                    echo '<h4>';                               
                                                    // echo '<input type="checkbox" id="'.$lastMenuId.'" name="'.$submenu1.'" value="'.$lastMenuId.'" class="menuClass">';                               
                                                    echo '<label class="col-form-label1" for="'.$lastMenuId.'">'.$submenu1.'/'.$submenu2.'</label>
                                                    </h4>';
                                                echo '<ul>';
                                                ...
                                                foreach ($submenu2Data['functions'] as $index => $subFunction) {
                                                    ...
                                                    if($subFunction)
                                                    {
                                                        ...
                                                        echo '<li>';
                                                        echo '<input type="checkbox" id="'.$submenu_label.'" name="'.$subFunction.'" class="menuClass" value="'.$submenu2Data['menu_id'][$index].'" '.$sbufunction_checked.'>';
                                                ...
                                                if (isset($lastarray[$main_menu][$submenu1][$submenu2])) {
                                                    foreach ($lastarray[$main_menu][$submenu1][$submenu2] as $menu_detail => $menuDetailData) {
                                                        ...
                                                        // {
                                                            echo '<input type="checkbox" id="'.$menu_detail.'" name="'.$menu_detail.'" class="menuClass">';
                                                        // }
                                                        echo '<label for="'.$menu_detail.'">'.$menu_detail.'</label>';
                                                        echo '<ul>';
                                                        ...
                                                        foreach ($menuDetailData['functions'] as $index => $detailFunction) {
                                                            ...
                                                            echo '<li>';
                                                            echo '<input type="checkbox" id="'.$checkbox_label.'" name="'.$detailFunction.'" class="menuClass" value="'.$menuDetailData['menu_id'][$index].'" '.$sbufunction_checked.'>';
                ...
                <div class="col-12 text-right mt-3">
                    ...
                    <button type="submit" id="save-btn"
                        class="btn btn-lg btn-primary"><?php echo $this->lang->line('Save') ?></button>
                </div>
            </form>
        </div>
    </div>
