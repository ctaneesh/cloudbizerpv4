    ...
    <div class="card-header border-bottom">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('bankingtransactions') ?>"><?php echo $this->lang->line('Bank Transactions') ?></a></li>
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line($type); ?></li>
                </ol>
            </nav>
            
        <h5 class="title"> <?php echo $this->lang->line($type)." (".$this->lang->line('Bank Transaction').")" ?></h5>
        ...
        <form method="post" id="data_form" class="form-horizontal">
            ...
            <div class="form-group row">                
                <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12">
                    ...
                    <input type="text" placeholder="Enter Transaction Number" value="<?=$transaction_number?>" class="form-control margin-bottom required" name="trans_number" id="trans_number" readonly>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12">
                    <label class="col-form-label" for="trans_date"><?php echo $this->lang->line('Date') ?><span class="compulsoryfld">*</span></label>
                    <input type="date" placeholder="Enter date" value="<?=date('Y-m-d')?>" class="form-control margin-bottom required" name="trans_date" id="trans_date">
                </div>
                <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                    ...
                    <select name="trans_account_id" id="trans_account_id" class="form-control" required>
                        <?php
                            ...
                            if ($bankaccounts)
                            {
                                $code = ($code) ? $code: $default_bank_account['code'];
                ...
                <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                    ...
                    <input type="number" placeholder="Enter Amount" class="form-control margin-bottom required" name="trans_amount" id="trans_amount">
                </div>

                <div class="col-lg-6 col-md-4 col-sm-12 col-xs-12">
                    <label class="col-form-label" for="holder"><?php echo $this->lang->line('Descriptions') ?></label>
                    <textarea name="trans_description" id="trans_description" class="form-textarea"></textarea>
                </div>
                             ...
                             foreach ($accounttypes as $parentItem) {
                                 ...
                                 if (isset($accountslist[$typename])) {
                                     ...
                                     foreach ($accountslist[$typename] as $childItem) {
                                         ...
                                         $acn1 = $childItem['acn'];
                                         $selected="";
                                        if($default_sales_account['acn'] == $acn1)
                                        {
                                            $selected = 'selected';
                                        }
                    ...
                    <?php
                        if ($category)
                        {
                            ...
                            foreach ($category as $row2) {
                                ...
                                echo "<option value='$transcat_id'>".$row2['transcat_name']."</option>";
                            }
                        }                            
                    ?>
                    </select>
                            ...
                            <?php
                                if ($customers)
                                {
                                    ...
                                    foreach ($customers as $row1) {
                                        $cid = $row1['id'];
                                        echo "<option value='$cid'>".$row1['name']."</option>";
                                    }
                                }                            
                            ?>
                        </select>
                ...
                <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                    ...
                    <input type="text" placeholder="Enter Amount" class="form-control margin-bottom" name="trans_reference" id="trans_reference">
                </div>
                <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
...
<script type="text/javascript">
    ...
    $('#transaction-btn').on('click', function(e) {
        ...
        if ($("#data_form").valid()) {                
            ...
            Swal.fire({
                title: "Are you sure?",
                text: "Do you want to create new transaction?",
                icon: "question",
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: baseurl + 'bankingtransactions/banktransaction_action', // Replace with your server endpoint
                        type: 'POST',
                        data: formData,
                        contentType: false, 
                        processData: false,
