<div class="content-body">
         ...
         <div class="card-header">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('customers') ?>"><?php echo $this->lang->line('Client Groups') ?></a></li>
                </ol>
            </nav>
            <h4 class="card-title"><?php echo $this->lang->line('Client Groups');  ?> <a href="<?php echo base_url('clientgroup/create') ?>" class="btn btn-primary btn-sm">Add New
                </a></h4>
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                ...
                <table id="cgrtable" class="table table-striped table-bordered zero-configuration">
                    <thead>
                    <tr>
                        <th style="width:5%; texxt-align:center">#</th>
                        <th style="width:30%;"><?php echo $this->lang->line('Name') ?></th>
                        <th style="width:10%;"><?php echo $this->lang->line('Total Clients') ?></th>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //datatables
            $('#cgrtable').DataTable({responsive: false});
