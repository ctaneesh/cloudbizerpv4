...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= assets_url() ?>assets/css/sweetalert.css<?= APPVER ?>">
    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mobile-menu d-md-none mr-auto"><a
                            class="nav-link nav-menu-main hidden-xs" href="<?= base_url() ?>dashboard/"><img  class="brand-logo" alt="logo" src="<?php echo base_url(); ?>userfiles/theme/logo-header.png"></a></li>
                <li class="nav-item mobile-menu d-md-none mr-auto mt-1"><a
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <li class="nav-item d-none d-md-block"><a class="navbar-brand" href="<?= base_url() ?>Dashboard/dashboard"><img  class="brand-logo" alt="logo" src="<?php echo base_url(); ?>userfiles/theme/logo-header.png">
                </a></li>
                    <li class="nav-item d-none d-md-block mt-1">
                        <a class="nav-link font-medium-2 hidden-xs pos-menuitems"    href="<?= base_url() ?>dashboard"><i class="ft-home"></i></a></li>

                    <li class="nav-item d-none d-md-block mt-1"><a onclick="alert('Press F11 to Full Screen in Google Chrome')" class="nav-link nav-link-expand hidden-sm breaklink" title="Press F11 to Full Screen" ><i
                                    class="ficon ft-maximize"></i></a></li>
                    <li class="nav-item d-none d-md-block nav-link "><a href="<?= base_url() ?>dashboard"
                                                                        class="btn btn-blue1 btn-md t_tooltip pos-menuitems" title="Dashboard"><i
                                    class="icon-speedometer"></i> </a>
                    </li>
                    <li class="nav-item d-none d-md-block nav-link "><a class="btn btn-blue1 btn-md t_tooltip pos-menuitems" title="View Register" data-toggle="modal" data-target="#register"><i
                                    class="icon-drawer"></i><?php //echo $this->lang->line('Register') ?> </a>
                    </li>
                    <li class="nav-item d-none d-md-block nav-link ">
                        <a data-toggle="modal" data-target="#close_register"  class="btn btn-danger1 btn-md t_tooltip pos-menuitems"  title="Close Register"> <i class="icon-close"></i></a>
                    </li>
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#"
                                    ...
                                    class="badge badge-pill badge-default badge-info badge-default badge-up" id="unreadmsgs1"><?php echo $this->aauth->count_unread_pms() ?></span></a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <h6 class="dropdown-header m-0"><span
            ...
            <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item hidden-sm-down"><input type="text"
                                                               ...
                                                               id="head-customerbox"
                                                               class="nav-link menu-search form-control"/></li>
                </ul>
