        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                    ...
                    <li class="nav-item"><a class="navbar-brand" href="<?= base_url() ?>Dashboard/dashboard"><img  class="brand-logo" alt="logo" src="<?php echo base_url(); ?>userfiles/theme/logo-header.png"></li>
                    ...
                    <?php   // if ($this->aauth->premission(12)) { ?>   
                        <li class="dropdown  nav-item d-none d-md-block">
                            <a href="<?= base_url() ?>pos_invoices/create" class="t_tooltip text-white nav-link nav-link-label" title="Access POS"><i
