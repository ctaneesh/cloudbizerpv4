...
<body class="horizontal-layout horizontal-menu 2-columns menu-expanded" data-open="click" data-menu="horizontal-menu"
   ...
   <!-- fixed-top-->
   <nav
      class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-static-top navbar-dark bg-gradient-x-grey-blue navbar-border navbar-brand-center" style="width: 100%;position: fixed;top: 0px;z-index: 9999;">
      <div class="navbar-wrapper">
         <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
               ...
               <li class="nav-item d-md-none"><a class="navbar-brand mobile-logo" href="<?= base_url() ?>Dashboard/dashboard"><img  class="brand-logo" alt="logo" src="<?php echo base_url(); ?>userfiles/theme/logo-header.png">
                  </a></li>

                

                   <li class="dropdown dropdown-notification nav-item mobile-only">
                  ...
                  <li class="dropdown dropdown-notification nav-item mobile-only">
                     ...
                     <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                        ...
                        <li class="dropdown-menu-footer mobile-only"><a class="dropdown-item text-muted text-center breaklink"
                           href="<?php echo base_url('messages') ?>"><?php echo $this->lang->line('Read all messages') ?></a>
                        </li>
                     </ul>
                  </li>
                  <?php if ($this->aauth->auto_attend()) { ?>
                  <li class="dropdown dropdown-d nav-item mobile-only">
                  ...
                  <?php } ?>
                  <li class="nav-item d-md-none dropdown nav-item mega-dropdown menu_assign_class open-navbar-container" data-access="Settings-918">
                      <a class="dropdown-toggle nav-link " href="#" data-toggle="dropdown"><i class="fa fa-gear fa-spin1 fontsize-16" style="font-size: 1.6rem !important;"></i></a>
                           ...
                           </ul><ul class="mega-dropdown-menu dropdown-menu row">
                              <li class="col-12">
                                 <div id="accordionWrap" role="tablist"  aria-multiselectable="true">
                                    <div class="card border-0 box-shadow-0 collapse-icon accordion-icon-rotate menu_assign_class"  data-access="Business_Settings-919">
                                       <div class="card-header p-0 pb-1 border-0 mt-1" id="heading1" role="tab">
                  ...
                  <li class="dropdown dropdown-user nav-item mobile-only">
            ...
            <div class="collapse navbar-collapse responsive-padding-top" id="navbar-mobile">
               <ul class="nav navbar-nav mr-auto float-left">
                ...
                //  if ($this->aauth->premission(12)) { ?>
                        <li class="nav-item1 nav-link menu_assign_class"   data-access="Access_POS-954">
                  ...
                  <li class="dropdown nav-item mega-dropdown menu_assign_class" data-access="Settings-918" >
                     <a class="dropdown-toggle nav-link " href="#"
   ...
   <div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-light navbar-without-dd-arrow navbar-shadow menu-border"  style="width: 100%;position: fixed;top: 60px !important;"
      ...
      <div class="navbar-container main-menu-content" data-menu="menu-container">
         ...
         <li class="dropdown nav-item menu_assign_class" data-menu="dropdown" data-access="Sales-111">
            ...
            <ul class="dropdown-menu">
               ...
               <li class="dropdown dropdown-submenu menu_assign_class" data-menu="dropdown-submenu" data-access="Buy_Requests-412">
