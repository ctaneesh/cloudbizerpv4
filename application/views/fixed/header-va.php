    ...
    <div class="main-menu-content">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <?php if ($this->aauth->get_user()->roleid == 5) { ?>
                ...
                <li class="nav-item "><a href="<?= base_url(); ?>Dashboard/dashboard"><i
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="menu-item"><a href="#"><i
                            ...
                            <ul class="menu-content">
                                ...
                                <li class="menu-item"><a class="dropdown-item" href="<?php echo base_url(); ?>salesorders"
                                                    data-toggle="dropdown"><?php echo $this->lang->line('Sales Orders'); ?></a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu-item">
                            <a href="<?php echo base_url(); ?>enquiry/"><i
                                        class="icon-screen-tablet"></i><?php echo $this->lang->line('Customer Enquiry'); ?>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="<?php echo base_url(); ?>DeliveryNotes/"><i
                                        class="icon-screen-tablet"></i><?php echo 'Delivery Notes'; ?>
                            </a>
                        </li>
