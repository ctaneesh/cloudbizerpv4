...
<div class="invoice-box" >
   <hr>
           ...
           <?php  } ?>
                ...
                <p><?php //echo $this->lang->line('Status') . ' : <strong>'. $this->lang->line(ucwords($invoice['status'])); ?></strong></p>
                    ...
                    if (!$general['t_type']) {
                       ...
                       // echo $this->lang->line('Paid Amount') . ' : <strong>' . ($invoice['pamnt']).'</strong><br>';
                    }
    ...
    echo '<div style="margin-top:15px; margin-bottom:10px; color:#2B2000;"><strong>Reason For Return</strong>
    <p style="font-size:15px; margin-top:4px;">'.$invoice['notes'].'</p></div>';    

    echo '<br><div class="sign">' . $this->lang->line('Authorized person') . '</div>';
