   ...
   <hr>
    ...
    <thead>
        <tr>
            ...
            <td style="text-align:right;"><strong>Debit Note No : <?= $purchasereturn_prefix.$invoice['tid']?></strong><br> <strong>Date : <?= date('d-m-Y', strtotime($invoice['invoicedate']))?></strong></td>
        </tr>
        </thead>
    ...
    <table class="subtotal">
           ...
           <?php  } ?>
                ...
                <p><?php echo $this->lang->line('Payment Status') . ' : <strong>'. $this->lang->line(ucwords($invoice['payment_status'])); ?></strong></p>
                    ...
                    if (!$general['t_type']) {
                       ...
                       echo "<br>". $this->lang->line('Paid Amount') . ' : <strong>' . number_format($invoice['pamnt'],2).'</strong><br>';
                    }
        ...
        <tr>
            ...
            $rming = $grandtotal - $invoice['pamnt'];
