    ...
    <table class="party">
        ...
        <tr>
            <td><strong><?php $loc = location($invoice['loc']);
                ...
                if ($loc['tax_id']) echo '<br>' . $this->lang->line('GSTIN') . ' : ' . $loc['tax_id'];
                ?>
            </td>
            ...
            <td>
                ...
                if ($invoice['tax_id']) echo '<br>' . $this->lang->line('GSTIN') . ' : ' . $invoice['tax_id'];
        ...
        </tr><?php if (@$invoice['shipping_name']) { ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    echo $invoice['shipping_address_1'] . '<br>' . $invoice['shipping_city'] . ', ' . $invoice['shipping_region'] . '<br>' . $invoice['shipping_country'] . '-' . $invoice['shipping_postbox'] . '<br> ' . $this->lang->line('Phone') . ': ' . $invoice['shipping_phone'] . '<br> ' . $this->lang->line('Email') . ': ' . $invoice['shipping_email'];
