...
@media print {
    @page {
        size: 180mm 107mm; /* width x height */
    ...
    .page {
        height: 107mm; /* Total page height */
        width: 180mm;
        position: relative;
        ...
        <div class="content">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= $i+1 ?></td>
                        <td><?= $products[$i]['product_code'] .' | ' .$products[$i]['product_name'] ?></td>
