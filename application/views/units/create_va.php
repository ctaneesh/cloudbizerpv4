<div class="card card-block">
    ...
    <div class="card card-block ">
        ...
        <form method="post" id="data_form" class="card-body">
            ...
            <h4 class="card-title"><?php echo $this->lang->line('Add') ?> <?php echo $this->lang->line('Variations') ?></h4>
            <hr>

            <div class="form-group row">
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-xs-12">
                    <label class="col-form-label" for="name"><?php echo $this->lang->line('Name') ?><span class="compulsoryfld">*</span></label>
                    <input type="text" placeholder="Name" class="form-control margin-bottom round required" name="name">
                </div>
            </div>
...
<script>
    ...
    $("#submit-btn").on("click", function (e) {
        ...
        if ($("#data_form").valid()) {
            ...
            Swal.fire({
               title: "Are you sure?",
               text: "Do you want to create variation?",
               icon: "question",
