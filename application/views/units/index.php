<div class="card card-block">
    ...
    <div class="card-header">
          <h4 class="card-title"> <?php echo $this->lang->line('Measurement Unit') ?> <a
        ...
        <table id="catgtable" class="table table-striped table-bordered zero-configuration dataTable" style="width:100% !important;">
            ...
            foreach ($units as $row) {
                ...
                echo "<tr>
                    ...
                    <td><a href='" . base_url("units/edit?id=$cid") . "' class='btn btn-secondary btn-sm' title='Edit'><i class='icon-pencil'></i></a>&nbsp;<a href='#' data-object-id='" . $cid . "' class='btn btn-secondary btn-sm delete-object' title='Delete'><i class='fa fa-trash'></i></a></td></tr>";
                $i++;
            }
            ?>
            </tbody>
