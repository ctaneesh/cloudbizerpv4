    ...
    <div class="card-body">
        ...
        <table id="catgtable" class="table table-striped table-bordered zero-configuration" cellspacing="0"
            ...
            <tr>
                ...
                <th style="width:15%;"><?php echo $this->lang->line('Variations') ?></th>
            ...
            foreach ($units as $row) {
                ...
                echo "<tr>
                    ...
                    <td><a href='" . base_url("units/edit_va?id=$cid") . "' class='btn btn-secondary btn-sm' title='Edit'><i class='fa fa-pencil'></i> </a>&nbsp;<a href='#' data-object-id='" . $cid . "' class='btn btn-secondary btn-sm delete-object' title='Delete'><i class='fa fa-trash'></i></a></td></tr>";
                $i++;
            }
            ?>
            </tbody>
