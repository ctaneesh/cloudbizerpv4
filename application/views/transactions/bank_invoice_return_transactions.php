...
<div class="content-body">
    <div class="card">
        <div class="card-header border-bottom">
            ...
            <!-- invoicecreditnotes/payment_return_to_customer_edit?id=1&csd=$transaction_records['trans_customer_id'] -->
            <h4 class="card-title"><?php echo $this->lang->line('Transaction')." #".$transaction_records['trans_ref_number']; ?>&nbsp;<a href="<?= base_url('invoicecreditnotes/payment_return_to_customer_edit?ref=' . $transaction_records['trans_ref_number'].'&csd='.$transaction_records['trans_customer_id'].'&id='.$invoice['id']); ?>" class="btn btn-crud btn-sm btn-primary"><?php echo $this->lang->line('Edit'); ?></a></h4>
                ...
                <div id="invoice-customer-details" class="row">
                    ...
                    <div class="col-md-8 col-sm-12 text-right">
                        ...
                        if($invoice)
                        {
                            ...
                            echo '<p class="text-muted">'.$this->lang->line('Related Invoice Return').'</p>';
                            echo '<p class="text-muted"><a href="' . base_url("invoicecreditnotes/view?id=$invoiceid") . '"><b>#'.$invoice['tid'].'</b></a></p>';
