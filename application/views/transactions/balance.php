        ...
        <div class="card-header border-bottom"> 
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line('BalanceSheet'); ?></li>
                </ol>
            </nav>
                ...
                <div class="table-scroll">
                    <table class="table table-striped table-bordered zero-configuration dataTable">
                        ...
                        <tr>
                            ...
                            <th>
                                <h5 class="text-xl-left"><?php echo amountExchange($gross, 0, $this->aauth->get_user()->loc); ?></h5>
                            </th>
                        </tr>
                        </tfoot>
                    </table>
                ...
                <div class="table-scroll">
                    <table class="table table-striped table-bordered zero-configuration dataTable">
                        ...
                        <tr>
                            ...
                            <th>
                                <h5 class="text-xl-left"><?php echo amountExchange($gross1, 0, $this->aauth->get_user()->loc); ?></h5>
                            </th>
                        </tr>
                        </tfoot>
                    </table>
                ...
                <div class="table-scroll">
                    <table class="table table-striped table-bordered zero-configuration dataTable">
                        ...
                        <tr>
                            ...
                            <th>
                                <h5 class="text-xl-left"><?php echo amountExchange($gross2, 0, $this->aauth->get_user()->loc); ?></h5>
                            </th>
                        </tr>
                        </tfoot>
                    </table>
                ...
                <div class="table-scroll">
                    <table class="table table-striped table-bordered zero-configuration dataTable">
                        ...
                        <tr>
                            ...
                            <th>
                                <h5 class="text-xl-left"><?php echo amountExchange($gross3, 0, $this->aauth->get_user()->loc); ?></h5>
                            </th>
                        </tr>
                        </tfoot>
                    </table>
                ...
                <div class="table-scroll">
                    <table class="table table-striped table-bordered zero-configuration dataTable">
                        ...
                        <tr>
                            ...
                            <th>
                                <h5 class="text-xl-left"><?php echo amountExchange($gross4, 0, $this->aauth->get_user()->loc); ?></h5>
                            </th>
                        </tr>
                        </tfoot>
                    </table>
                ...
                <div class="table-scroll">
                    <table class="table table-striped table-bordered zero-configuration dataTable">
                        ...
                        <tr>
                            ...
                            <th>
                                <h5 class="text-xl-left"><?php echo amountExchange($gross5, 0, $this->aauth->get_user()->loc); ?></h5>
                            </th>
                        </tr>
                        </tfoot>
                    </table>
