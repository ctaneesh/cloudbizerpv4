             ...
             ?>
                ...
                <div class="text-right">
                    ...
                    <div class="btn-group btn-group filter-group">
                        <button type="button" class="btn btn-outline-secondary navsearch" id="today" onclick="today()"><div class="filter-day-count  d-flex justify-content-between"><div><?php echo $this->lang->line('Today'); ?></div><div><?php echo $enquirycounts->daily_count; ?></div></div>
                        <div class="filter-day-value">
                        <?php   echo "Debit : <strong class='success'>". $enquirycounts->daily_debit."</strong></span>";
                                echo " <span>Credit : <strong class='danger'>".$enquirycounts->daily_credit."</strong></span>";
                                // echo "<span class='success'> Closed : ".$enquirycounts->daily_closed_count."</span>"; 
                        ?>
                        </div>
                        </button>
                        
                        <button type="button" class="btn btn-outline-secondary navsearch" id="week" onclick="week()"><div class="filter-day-count  d-flex justify-content-between"><div><?php echo $this->lang->line('Week'); ?></div><div><?php echo $enquirycounts->weekly_count; ?></div></div><div class="filter-day-value">
                            <?php   echo "Debit : <strong class='success'>". $enquirycounts->weekly_debit."</strong></span>";
                                echo " <span>Credit : <strong class='danger'>".$enquirycounts->weekly_credit."</strong></span>";;
                                // echo " Closed : ".$enquirycounts->weekly_closed_count; 
                        ?></div> 
                        </button>

                        
                        <button type="button" class="btn btn-outline-secondary navsearch" id="month" onclick="month()"><div class="filter-day-count  d-flex justify-content-between"><div><?php echo $this->lang->line('Month'); ?></div><div><?php echo $enquirycounts->monthly_count; ?></div></div>
                        <div class="filter-day-value">
                            <?php   echo "Debit : <strong class='success'>". $enquirycounts->monthly_debit."</strong></span>";
                                echo " <span>Credit : <strong class='danger'>".$enquirycounts->monthly_credit."</strong></span>";
                                // echo " Closed : ".$enquirycounts->monthly_closed_count; 
                        ?></div> 
                        </button>
                        
                        
                        <button type="button" class="btn btn-outline-secondary navsearch" id="quarter" onclick="quarter()"><div class="filter-day-count  d-flex justify-content-between"><div><?php echo $this->lang->line('Quarter'); ?></div><div><?php echo $enquirycounts->quarterly_count; ?></div></div><div class="filter-day-value">
                            <?php   echo "Debit : <strong class='success'>". $enquirycounts->quarterly_debit."</strong></span>";
                                echo " <span>Credit : <strong class='danger'>".$enquirycounts->quarterly_credit."</strong></span>";
                                // echo " Closed : ".$enquirycounts->quarterly_closed_count; 
                        ?></div> 
                        </button>

                        <button type="button" class="btn btn-outline-secondary navsearch" id="year" onclick="year()"><div class="filter-day-count  d-flex justify-content-between"><div><?php echo $this->lang->line('Year'); ?></div><div><?php echo $enquirycounts->yearly_count; ?></div></div>
                        <div class="filter-day-value">
                        <?php   echo "Debit : <strong class='success'>". $enquirycounts->yearly_debit."</strong></span>";
                                echo " <span>Credit : <strong class='danger'>".$enquirycounts->yearly_credit."</strong></span>";
                                // echo " Closed : ".$enquirycounts->yearly_closed_count; 
                        ?></div> 
                        </button>
