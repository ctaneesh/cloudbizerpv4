        ...
        <div class="card card-block">
            ...
            <form method="post" id="data_form" class="card-body">
                   ...
                   <div class="row">
                    <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line('Add Printer') ?></li>
                            </ol>
                        </nav>
                        <h4 class="card-title w-100"><?php echo $this->lang->line('Add Printer') ?></h4>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-xs-12">
                        <label class="col-form-label"
                           for="lid">Printing Mode<span class="compulsoryfld">*</span></label>
...
<script>
    ...
    $("#submit-btn").on("click", function (e) {
        ...
        if ($("#data_form").valid()) {
            ...
            Swal.fire({
               title: "Are you sure?",
               text: "Do you want to add a new printer?",
               icon: "question",
