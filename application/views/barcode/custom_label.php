     ...
     for ($i = 0; $i <= $style['total_rows']; $i++) {
         for ($z = 0; $z <= $style['items_per_row']; $z++) {
             ...
             if ($style['product_name'])  echo substr($lab['product_name'],0,$style['max_char']);
              ...
              echo'<br><img src="data:image/png;base64,' . base64_encode($generator->getBarcode($lab['selected_barcode'] , $t)) . '" style=" margin: 0;width:'.$style['bar_width'].'mm;height:'.$style['bar_height'].'mm;"><br>';
              echo  $lab['selected_barcode'].'<br>' ;
