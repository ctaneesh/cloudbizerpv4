        ...
        <div class="card-content">
            ...
            <div id="invoice-template" class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-12">
                        ...
                        <div class="title-action">
                            ...
                            <a href="<?php echo 'edit?id=' . $invoice['iid']; ?>" class="btn btn-sm btn-warning mb-1"><i
                            ...
                            <a href="#part_payment" data-toggle="modal" data-remote="false" data-type="reminder"
                                class="btn btn-sm btn-info mb-1" title="Partial Payment"><span
                                    class="fa fa-money"></span> <?php echo $this->lang->line('Make Payment') ?> </a>

                            <div class="btn-group">
                                <button type="button" class="btn btn-sm btn-danger dropdown-toggle mb-1"
                            ...
                            <!-- SMS -->
                            <div class="btn-group">
                                <button type="button" class="btn btn-sm btn-blue dropdown-toggle mb-1"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <a href="#pop_model" data-toggle="modal" data-remote="false"
                                class="btn btn-sm btn-blue mb-1" title="Change Status"><span
                                    class="fa fa-retweet"></span> <?php echo $this->lang->line('Change Status') ?></a>
                            <a href="#cancel-bill" class="btn btn-sm btn-danger mb-1" id="cancel-bill"><i
                                    class="fa fa-minus-circle"> </i> <?php echo $this->lang->line('Cancel') ?>
                            </a>
                            <div class="btn-group ">
                                <button type="button" class="btn btn-sm  btn-danger mb-1 btn-min-width dropdown-toggle"
                    ...
                    <div class="col-md-5 col-sm-12 text-md-right text-sm-left">
                        <div class="btn-group ">
                            <button type="button" class="btn btn-sm btn-secondary mb-1 btn-min-width dropdown-toggle"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
                        ...
                        <a href="<?php echo $link; ?>" class="btn btn-sm btn-danger mb-1"><i class="fa fa-globe"></i>
                ...
                <div id="invoice-customer-details" class="row pt-2">
                    ...
                    <div class="offset-md-3 col-md-3 col-sm-12 text-md-right text-sm-left">
                ...
                <div id="invoice-items-details" class="pt-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 col-sm-12">
                            ...
                            <div class="text-xs-right text-md-right text-sm-left">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="emailbody" style="display: none;">
                <form id="sendbill">
                    ...
                    <div class="row">
                        <div class="col"><label
                                for="shortnote"  class="col-form-label"><?php echo $this->lang->line('Customer Name'); ?></label>
                            <input type="text" class="form-control" name="customername"
                                value="<?php echo $invoice['name'] ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col"><label  class="col-form-label" for="shortnote"><?php echo $this->lang->line('Subject'); ?></label>
                            <input type="text" class="form-control" name="subject" id="subject">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col"><label  class="col-form-label" for="shortnote"><?php echo $this->lang->line('Message'); ?></label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_model">
                    ...
                    <div class="row">
                        <div class="col"><label  class="col-form-label" for="pmethod"><?php echo $this->lang->line('Mark As') ?></label>
