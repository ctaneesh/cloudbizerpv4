    ...
    function exportpdf()
    {
        ...
        foreach ($list as $invoices) {
            $data1[]=[
                ...
                "qty"=>amountFormat_general($invoices->qty),
                "discount"=>amountExchange($invoices->discount, 0, $this->aauth->get_user()->loc),
                "tax"=>amountExchange($invoices->tax, 0, $this->aauth->get_user()->loc),
                "amount"=>amountExchange($invoices->subtotal, 0, $this->aauth->get_user()->loc)
            ];
