    ...
    <div class="row ">
        <div class="col-md-6 card p-mobile">
            <div class="input-group mt-1">
                <a href='#'
                   class="btn btn-crud btn-primary  round "
                   data-toggle="modal"
            ...
            <div id="saman-row-pos" class="rqw mt-1">
                ...
                <div class="row mt-1">
                    <div class="col-md-12 text-center">
                        <a href="#" class="possubmit btn btn-crud btn-secondary sub-btn" data-type="6"
                        ><i class="fa fa-save"></i> <?php echo $this->lang->line('Draft') ?></a>
                        <a href="#" class="possubmit3  btn btn-crud btn-secondary sub-btn" data-type="6"
                           data-toggle="modal"
                        ...
                        <?php if ($enable_card['url']) { ?>
                            <a href="#"
                               class="possubmit2 btn btn-crud btn-secondary sub-btn"
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="btn btn-crud btn-secondary mb-1" id="base-tab4" data-toggle="tab" aria-controls="tab4"
                            ...
                            <input type="text" class="form-control"
                                   id="coupon" name="coupon"><input type="hidden"
                                    ...
                                    class="input-group-addon round"> <button
                                        class="apply_coupon btn btn-small btn-primary sub-btn  btn-sm"><?php echo $this->lang->line('Apply') ?></button></span>
