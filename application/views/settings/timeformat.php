<div class="card card-block">
    ...
    <form method="post" id="data_form" class="form-horizontal">
        <div class="card-body">
            ...
            <h4 class="card-title"><?php echo $this->lang->line('Date & Time Format') ?></h4>
            <hr>
            ...
            <div class="form-group row">
                <div class="col-xl-6 col-lg-4 col-md-12 col-sm-12 col-xs-12 submit-section responsive-text-right">
 ...
 $("#data_form").validate({
    ...
    $("#submit-btn").on("click", function (e) {
        ...
        if ($("#data_form").valid()) {
            ...
            Swal.fire({
               title: "Are you sure?",
               text: "Do you want to update Date & Time Format?",
               icon: "question",
               ...
               if (result.isConfirmed) {  
                    $.ajax({
                        type: 'POST',
                        url: baseurl + 'settings/dtformat',
                        data: formData,
                        contentType: false,
                        processData: false,
                        dataType: "json",
                        success: function(response) {
                            window.location.href = baseurl + 'settings/dtformat';
                        },
