...
$("#data_form").validate({
        ...
        messages: {
            serial: "Select Product Search Setting",
        },
        errorElement: "em",
    ...
    $("#submit-btn").on("click", function (e) {
        ...
        if ($("#data_form").valid()) {
            ...
            Swal.fire({
               title: "Are you sure?",
               text: "Do you want to update billing settings?",
               icon: "question",
               ...
               if (result.isConfirmed) {  
                    $.ajax({
                        type: 'POST',
                        url: baseurl + 'settings/billing_settings',
                        data: formData,
                        contentType: false,
                        processData: false,
                        dataType: "json",
                        success: function(response) {
                            window.location.href = baseurl + 'settings/billing_settings';
                        },
