<div class="card card-block">
    ...
    <div class="card-body">
        <h4 class="card-title"> <?php echo $this->lang->line('Custom') ?>  <?php echo $this->lang->line('Fields') ?> <a
            ...
            <table id="catgtable" class="table table-striped table-bordered zero-configuration"
                ...
                foreach ($customfields as $row) {
                    ...
                    echo "<tr>
                        ...
                        <td><a href='" . base_url("settings/edit_custom_field?id=" . $row['id']) . "' class='btn btn-secondary btn-sm' title='Edit'><i class='fa fa-pencil'></i></a>&nbsp;<a href='#' data-object-id='" . $row['id'] . "' class='btn btn-secondary btn-sm delete-object' title='Delete'><i class='fa fa-trash'></i></a></td></tr>";
