<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title"> <?php echo $this->lang->line('Billing Terms') ?> <a
            ...
            <div class="card-body">
                ...
                <table id="tttable" class="table table-striped table-bordered zero-configuration" cellspacing="0"
                    ...
                    foreach ($terms as $row) {
                        ...
                        <td><a href='" . base_url("settings/edit_term?id=$cid") . "' class='btn btn-secondary btn-sm' title='Edit'><i class='fa fa-pencil'></i></a>&nbsp;<a href='#' data-object-id='" . $cid . "' class='btn btn-secondary btn-sm delete-object' title='Delete'><i class='fa fa-trash'></i></a></td></tr>";
                        $i++;
                    }
                    ?>
                    </tbody>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //datatables
            $('#tttable').DataTable({responsive: false});
