<div class="card card-block">
    <div class="card-body">
        ...
        <form method="post" id="data_form" class="card card-block">
            <div class="card">

                <h4 class="card-title"><?php echo $this->lang->line('Auto Email SMS') ?></h4>
                ...
                <div class="form-group row">
                    <div class="col-xl-6 col-lg-8 col-md-12 col-sm-12 col-xs-12 responsive-text-right">
...
$("#data_form").validate({
    ...
    $("#submit-btn").on("click", function (e) {
        ...
        if ($("#data_form").valid()) {
            ...
            Swal.fire({
               title: "Are you sure?",
               text: "Do you want to update Auto Email SMS?",
               icon: "question",
               ...
               if (result.isConfirmed) {  
                    $.ajax({
                        type: 'POST',
                        url: baseurl + 'settings/automail',
                        data: formData,
                        contentType: false,
                        processData: false,
                        dataType: "json",
                        success: function(response) {
                            window.location.href = baseurl + 'settings/automail';
                        },
