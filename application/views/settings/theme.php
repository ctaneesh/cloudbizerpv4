            ...
            <div class="card-body">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-xs-12">
                    <label class="col-form-label"
                           ...
                           <select name="tdirection" class="form-control">
                ...
                <div class="form-group row">
                    <div class="col-lg-8 col-sm-12 submit-section">
                        <input type="submit" id="billing_update" class="btn btn-primary btn-lg margin-bottom"
