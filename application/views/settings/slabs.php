<article class="content-body">
    <div class="card card-block">
        ...
        <div class="card-body">
            ...
            <hr>
            <table class="table table-striped table-bordered zero-configuration dataTable" cellspacing="0"
            width="100%">
                <thead>
                <tr>
                ...
                <?php foreach ($catlist as $row) {
                    ...
                    echo "<tr><td>" . $row['val1'] . "</td><td>" . $row['val2'] . "%</td><td>" . $t1 . "</td><td><a href='#' data-object-id='" . $cid . "' class='btn btn-secondary btn-sm delete-object' title='Delete'><i class='fa fa-trash'></i></a></td></tr>";
                }
                ?>
                </tbody>
