                                    ...
                                    <table class="table table-striped table-bordered zero-configuration dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="last-item-row sub_c">
                                                ...
                                                <input type="hidden" class="prid" name="prid" id="prid" value="<?=$enquirymain['id']?>">
                                                <input type="hidden" class="lead_id" name="lead_id" id="lead_id" value="<?=$enquirymain['lead_id']?>">
