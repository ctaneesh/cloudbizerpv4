                        ...
                        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 cmp-pnl">
                            <div class="inner-cmp-pnl">
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12 d-none"><label for="invocieno"
                                    ...
                                    <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12"><label for="invociedate"
                                        ...
                                        <div class="input-group">
                                            <input type="date" class="form-control"
                                                   placeholder="Billing Date" name="invoicedate" value="<?=date('Y-m-d')?>" readonly>
                                        </div>
                                    </div>
                    ...
                    <div id="saman-row">
                        <table class="table table-striped table-bordered zero-configuration dataTable">
                            ...
                            <tr class="sub_c d-none" style="display: table-row;"> 
                                <td colspan="4" class="reverse_align no-border"><input type="hidden" value="0" id="subttlform" name="subtotal"><strong><?php echo $this->lang->line('Total Tax') ?></strong>
                                </td>
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                ...
                                <td align="right" colspan="2" class="no-border">
                                    ...
                                    <span id="discs" class="lightMode"><?=number_format($master_data['discount'],2)?></span></td>
                            </tr>
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                <td colspan="3" class="no-border"></td>
                                <td class="reverse_align no-border" colspan="3"><input type="submit"  class="btn btn-crud btn-lg btn-primary sub-btn btn-lg"  value="<?php echo $this->lang->line('Generate Invoice') ?> "   id="delivery-note-to-invoice-btn" data-loading-text="Creating...">
