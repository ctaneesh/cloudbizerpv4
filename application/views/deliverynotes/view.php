                    ...
                    <div class="">
                        ...
                        if ($invoice['status'] != 'canceled') { ?>
                            ...
                            <a href="#part_payment" data-toggle="modal" data-remote="false" data-type="reminder"
                               class="btn btn-sm btn-info mb-1" title="Partial Payment"
                            ><span class="fa fa-money"></span> <?php echo $this->lang->line('Make Payment') ?> </a>

                            <div class="btn-group">
                                <button type="button" class="btn btn-sm btn-facebook dropdown-toggle mb-1"
                            ...
                            <div class="btn-group ">
                                <button type="button" class="btn btn-sm btn-success mb-1 btn-min-width dropdown-toggle"
                            ...
                            <a href="<?php echo $link; ?>" class="btn btn-sm btn-blue-grey mb-1"><i
                                        class="fa fa-globe"></i> <?php echo $this->lang->line('Preview') ?>
                            </a>

                            <a href="#pop_model" data-toggle="modal" data-remote="false"
                               class="btn btn-sm btn-cyan mb-1" title="Change Status"
                            ...
                            <div class="btn-group ">
                                <button type="button" class="btn btn-sm btn-primary mb-1 btn-min-width dropdown-toggle"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
                            ...
                            <div class="btn-group ">
                                <button type="button" class="btn btn-sm btn-vimeo mb-1 btn-md dropdown-toggle"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
