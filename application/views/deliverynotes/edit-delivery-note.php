<div class="content-body">
    <div class="card">
        <div class="card-header border-bottom">
            <?php
            if($notemaster['notestatus']=="Printed"){
            ...
            <div class="row">
                ...
                <h4 class="card-title"><?php echo $this->lang->line('Delivery Note'). " #".$notemaster['delnotenumber']." ".$invoiceBtn." ".$deliveryBtn; ?></h4>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">  
                    <ul id="trackingbar">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-xs-12"><label
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" class="form-control"
                                                    placeholder="Delivery Note Number" name="invocieno" id="invocienoId"
                                                    value="<?php echo $notemaster['delevery_note_id']; ?>"
                                                    readonly>
                                                <input type="text" class="form-control"
                                                    placeholder="Delivery Note Number" name="delnote_number" id="delnote_number"
                                                    value="<?php echo $notemaster['delnotenumber']; ?>"
                                                    readonly>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-xs-12"><label
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="refer1" id="refer1"
                                                    ...
                                                    <input type="hidden" class="form-control" name="salesorder_id" id="salesorder_id" value="<?php echo $notemaster['salesorder_id']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-xs-12"><label
                                                for="invociedate"
                            ...
                            <table class="table table-striped table-bordered zero-configuration dataTable">
                                <thead>
                                    ...
                                    <tr class="item_header bg-gradient-directional-blue white">
                                        ...
                                        <th width="25%" class="text-center1">Item Name & No.</th>
                                        ...
                                        if($configurations['config_tax']!='0'){  ?>
                                         ...
                                         <?php } ?>
                                        <th width="10%" class="text-right">Total Discount</th>
                                ...
                                foreach ($products as $row) {
                                    ...
                                    echo '<td width="2%">'.$j.' <input type="checkbox" class="checkedproducts d-none" name="product_id[]" value="'.$row['pid'].'" id="prd-'.$row['pid'].'" checked><input type="checkbox" class="checkedproducts1 d-none" name="product_id_sub[]" value="'.$row['pid'].'" id="prd-'.$row['pid'].'" checked ></td>';
                                   ...
                                   autocomplete="off" value="' . amountExchange_s($row['product_price'], $notemaster['multi'], $this->aauth->get_user()->loc) . '"></td>';
                                    ...
                                    //  echo '<td><strong>'.$row['discount'].'</strong></td>';
                                        echo '<td class="text-right"><strong id="discount-amtlabel-' . $i . '" class="discount-amtlabel discount-amtlabel-' . $i . '">Amount : '.$row['deliverytotaldiscount'].'</strong></td>';
                                    ...
                                    <tr class="sub_c" style="display: table-row;">
                                        <td colspan="7" class="no-border" align="right"><strong>Total Discount(<span class="currenty lightMode"><?php echo $this->config->item('currency'); ?></span>)</strong></td>
                                        <td align="left" class="no-border" colspan="2">
                                            <span id="discs"
                                                class="lightMode"><?=$discountrate?></span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="sub_c" style="display: table-row;">
                                        ...
                                        <?php
                                             $grandtotal = 0;
                                             $grandtotal = ($productrate);
                                            //  $grandtotal = ($productrate)-$discountrate;
                                        ?>
                                        <td align="left" colspan="2" class="no-border"><input type="text" name="total"
                                                class="form-control" id="invoiceyoghtml"
                                    ...
                                    <tr class="sub_c" style="display: table-row;">
                                        ...
                                        <?php                   
                                            if($notemaster['notestatus']=='Draft' || $notemaster['notestatus']=='Assigned')
                                            {
                                        ?>
                                            <input type="submit" class="btn btn-lg btn-secondary sub-btn" value="Save As Draft" id="update-deliverynote-draft"  data-loading-text="Updating...">
                                            <input type="submit" class="btn btn-lg btn-primary sub-btn" value="Update" id="update-deliverynote"  data-loading-text="Updating...">
                                        <?php } 
                                        else if($notemaster['notestatus']!='Invoiced')
                                        {                                           
                                            ?>
                                            <!-- <a href="#" id="printBtn" class="btn btn-lg btn-primary sub-btn" data-delivery="<?=$notemaster['delevery_note_id'] ?>" data-sales="<?=$notemaster['salesorder_number']?>" data-cust="<?=$notemaster['csd']?>"><i class="fa fa-print"></i> Print</a> -->
                                        <?php } ?>
                                        </td>
                                    </tr>
...
$("#update-deliverynote-draft").on("click", function(e) {
    e.preventDefault();
    var selectedProducts1 = [];
    var validationFailed = false;
    var formData = $("#data_form").serialize(); 
