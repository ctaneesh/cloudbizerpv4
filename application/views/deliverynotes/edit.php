            ...
            <div class="card-body">
                <form method="post" id="data_form">
                    ...
                    <div class="row">
                        ...
                        <td class="text-center"><button type="button" data-rowid="' . $i . '" class="btn-sm btn-default removeProd border-0" title="Remove"> <i class="fa fa-trash"></i> </button>
                        </td>
                  ...
                  echo'  </tr> <tr class="desc_p"><td colspan="8"><textarea id="dpid-' . $i . '" class="form-control" name="product_description[]" placeholder="' . $this->lang->line('Enter Product description') . '" autocomplete="off">' . $row['product_des'] . '</textarea><br></td></tr>';
                                ...
                                <tr class="sub_c" style="display: table-row;">
                                    ...
                                    <td class="reverse_align" colspan="6"><input type="submit" class="btn btn-lg btn-primary sub-btn"
