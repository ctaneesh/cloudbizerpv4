        ...
        <div class="card-header border-bottom">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line('Credit Note')." #".$notemaster['tid']; ?></li>
                </ol>
            </nav>
            
            <div class="row">
                <div class="col-xl-4 col-lg-3 col-md-4 col-sm-12 col-xs-12">
                    <h4 class="card-title"><?php echo $this->lang->line('Credit Note')." #".$notemaster['tid']; ?> </h4>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-2 col-lg-4 col-md-6 col-sm-12 col-xs-12"><label for="invocieno"  class="col-form-label"><?php echo $this->lang->line('Credit Note Number'); ?>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control"  placeholder="Invoice Return Number" name="invocieno" id="creditnotetid" value="<?php echo $notemaster['tid']; ?>"  readonly>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <label for="invocieno"  class="col-form-label"><?php echo $this->lang->line('Note'); ?> <span class="compulsoryfld"> *</span></label>
                                            <textarea name="notes" id="notes" class="form-textarea" minlength="5"><?php echo $notemaster['notes']; ?></textarea>
                        ...
                        <div id="saman-row">
                            <table class="table table-striped table-bordered zero-configuration dataTable">
                                ...
                                foreach ($products as $row) {
                                    ...
                                    echo '<td class="text-center"><strong>'.intval($row['qty']).'</strong> <input type="hidden"  id="delivery_returned_qty-' . $i . '" value="'.intval($row['qty']).'"></td>';
                                    
                                    echo '<td style="text-align:center;"><input type="number" class="form-control req prc" '.$disableclass.' name="return_qty[]" id="amount-' . $i . '" onkeypress="return isNumber(event)"  placeholder="'.$this->lang->line('Enter Qty').'" onkeyup="calculateDeliveryReturn(' . $i . ')" value="'.intval($row['qty']).'"><input type="hidden" class="form-control" name="return_qty_old[]"   value="'.intval($row['qty']).'"></td>';
                                    
                                    echo '<td style="text-align:center;"><input type="number" class="form-control req prc" '.$disableclass.'  name="damaged_qty[]" id="damaged_qty-' . $i . '" value="'.intval($row['damaged_qty']).'" onkeypress="return isNumber(event)" onkeyup="damageqtycheck(' . $i . ')" placeholder="'.$this->lang->line('Enter Qty').'"><input type="hidden" class="form-control"name="damaged_qty_old[]"   value="'.intval($row['damaged_qty']).'"></td>';
                                   ...
                                   if($configurations['config_tax']!='0')
                                   {
                                    ...
                                    // <!-- erp2024 modified section 07-06-2024 -->
                                       echo '<td class="text-center"><strong id="discount-amtlabel-' . $i . '" class="discount-amtlabel discount-amtlabel-' . $i . '">'.$row['totaldiscount'].'</strong></td>';
                                        ...
                                        <input type="text" class="form-control" name="discount_type[]" id="discounttype-' . $i . '"   value="'.$row['discount_type'].'">
                                ...
                                ?>
                                    ...
                                    <tr class="sub_c" style="display: table-row;">
                                        ...
                                        <input type="submit" id="submit-invoice-return" class="btn btn-primary btn-lg submitBtn" value="<?php echo $this->lang->line('Confirm & Return'); ?>"/>
