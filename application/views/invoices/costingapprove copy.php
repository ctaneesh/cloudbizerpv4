    ...
    <div class="card-header border-bottom">
      <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item"><a href="<?= base_url('purchase/create?id=' . $purchaseorderdata['id']) ?>"><?php echo $this->lang->line('Purchase Order')." #".$purchaseorderdata['tid']; ?></a></li>               
               <li class="breadcrumb-item"><a href="<?= base_url('invoices/stockreciepts') ?>"><?php echo $this->lang->line('Stock Reciepts') ?></a></li>
               <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line('Purchase Items Receipt')." #".$purchasemasterdata['srv'] ?></li>
            </ol>
      </nav>
      <div class="row">
            <div class="col-12">
                <div class="row">
                    <div class="col-md-3">
                        <div class="fcol-sm-12">
                            <h3 class="title-sub">
                            <?php echo " #".$purchasemasterdata['srv']; ?>
                            </h3>
                        </div>
                    </div>
                    <div class="col-md-6 text-center">
                        ...
                        if($purchasemasterdata['approvalflg']==1)
                        {
                           ...
                           // $acceptbtn="d-none";
                            ...
                            $acceptsendbtncls="";
                            switch (true) {
                                case ($purchasemasterdata['prepared_flg'] == 0):
                                $msgcls = "d-none";
                                ...
                                case ($purchasemasterdata['approvalflg'] != 1 && $purchasemasterdata['prepared_flg'] == 1):
                                ...
                                case ($purchasemasterdata['reciept_status'] == "Received"):
                                    $messagetext = "Current Status : Items Recieved";
                                    $msgcls = "";
                                    $enabledisablecls ="";
                                break;
                        ...
                        if(!empty($trackingdata))
                            {
                                ...
                                { ?>
                                    <li style="width:30% !important;"><a href="<?= base_url('purchase/create?id=' . $trackingdata['purchase_order_number']) ?>" target="_blank">PO #<?= $trackingdata['purchase_order_number']; ?></a></li>
                                
                                    <li class="active" style="width:30% !important;">PR #<?php echo $purchasemasterdata['srv']; ?></li><?php
                                }
                            } ?>
                     ...
                     <!-- ========================= Buttons start ===================== -->
                            ...
                            <?php
                                ...
                                if ($invoice['status'] != 'canceled') { ?>
                                    <div class="title-action">
                                        ...
                                        ?>
                                        <a href='<?= base_url("purchase/purchase_receipt_payment?id=" . $purchasemasterdata['id'] . "&csd=" . $purchasemasterdata['supplier_id']) ?>' class="btn btn-sm  btn-secondary <?=$items_not_recieved?> <?=$payment_disable?>" title="Partial Payment"><span class="fa fa-money"></span> <?php echo $this->lang->line('Make Payment') ?> </a>
                                        ...
                                        <a href="#sendEmail" data-toggle="modal" data-remote="false" class="btn btn-sm btn-secondary sendbill <?php echo $enabledisablecls; ?> <?=$items_not_recieved?>" title="Email"  data-type="purchase"><span class="fa fa-envelope-o"></span> <?php echo $this->lang->line('Send') ?></a>

                                        <a href="#sendSMS" data-toggle="modal" data-remote="false" class="btn btn-sm btn-secondary <?php echo $enabledisablecls; ?> <?=$items_not_recieved?>" title="SMS"><span class="fa fa-mobile"></span> <?php echo $this->lang->line('SMS') ?></a>
                                        <?php
                                            $reciptid= $costid;
                                            $validtoken = hash_hmac('ripemd160', 'p' . $costid, $this->config->item('encryption_key'));
                                        ?>
                                        
                                        <a href="<?=base_url("stockreturn/create?id=$reciptid&token=$validtoken")?>"  class="btn btn-sm btn-secondary <?php echo $enabledisablecls; ?> <?=$items_not_recieved?>" title="Email"  data-type="purchase"><span class="fa fa-undo"></span> <?php echo $this->lang->line('Purchase Return') ?></a>
                                        ...
                                        { ?>
                                        <input type="submit" class="btn btn-sm btn-secondary cancelreceipt-btn <?=$items_not_recieved?>" value="<?php echo $this->lang->line('Cancel Purchase Receipt') ?>">
                                        <?php } ?>
                                    </div>
                                    <?php
                                        if ($invoice['multi'] > 0) {
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-12 text-lg-right text-md-right text-sm-left">
                                ...
                                <div class="btn-group ">
                                        ...
                                        <a class="dropdown-item" target="_blank" href="<?= base_url('billing/printporeciept?id=' . $purchasemasterdata['id'] . '&token=' . $validtoken); ?>"><?php echo $this->lang->line('Print') ?></a>
                                        <div class="dropdown-divider"></div>
                                            <a class="dropdown-item"
                                            href="<?= base_url('billing/printporeciept?id=' . $purchasemasterdata['id'] . '&token=' . $validtoken); ?>&d=1"><?php echo $this->lang->line('PDF Download') ?></a>
                                        </div>
                                </div>
                        </div>
                        </div>
                        ...
                        <div class="col-12 form-group row">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="">
                                            <input type="text" class="form-control customer_name" title="Party Name" name="party_name" id="party_name" placeholder="Party Name" value="<?php echo $purchasemasterdata['party_name']; ?>"  data-original-value="<?php echo $purchasemasterdata['party_name']; ?>" autocomplete="off" />
                                        </div>
                                    </div> 
                                </div>   
                            </div>   
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        <div class="frmclasss">
                                            <input type="text" class="form-control customer_name" title="Damage Claim A/c" name="damageclaim_ac_name" id="account-search" placeholder="" autocomplete="off" value="<?php echo $purchasemasterdata['damageclaim_ac_name']; ?>" data-original-value="<?php echo $purchasemasterdata['damageclaim_ac_name']; ?>"/>
                                        </div>
                            ...
                            <!-- ================== starts ===================== -->
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                <label class="col-form-label" for="bill_number"><?php echo 'Bill #'; ?></label>
                                <input type="number" class="form-control" title="Bill" name="bill_number" id="bill_number" placeholder="" autocomplete="off" value="<?php echo $purchasemasterdata['bill_number']; ?>" data-original-value="<?php echo $purchasemasterdata['bill_number']; ?>" required/>                           
                            </div>                             
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                <label class="col-form-label" for="bill_date"><?php echo 'Bill Date'; ?></label>
                                <input type="date" class="form-control" title="Bill Date" name="bill_date" id="bill_date" placeholder="" autocomplete="off" value="<?php echo $purchasemasterdata['bill_date']; ?>" data-original-value="<?php echo $purchasemasterdata['bill_date']; ?>"/>
                            </div>       
                            <!-- ================== Ends ======================= -->
                            <!-- ================== starts ===================== -->
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <!-- ================== starts ===================== -->
                             <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <textarea name="bill_description" title="Description" id="bill_description" class="form-control" data-original-value="<?php echo $purchasemasterdata['bill_description']; ?>"><?php echo $purchasemasterdata['bill_description']; ?></textarea>
                            </div>     
                            <!-- ================== Ends ======================= -->
                            ...
                            <!-- ================== starts ===================== -->
                             <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                    <label class="col-form-label"><?php echo 'Purchase Receipt No.'; ?><i clasa="text-danger">*</i></label>
                                    <div class="frmSearch1">
                            ...
                            <!-- ================== starts ===================== -->
                             <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                    <label class="col-form-label" for="srvdate"><?php echo 'Purchase Receipt Date'; ?><i clasa="text-danger">*</i></label>
                                    <div class="frmSearch1">
                                        <input type="date" class="form-control" name="srvdate" id="srvdate"
                                                autocomplete="off" value="<?php echo $purchasemasterdata['srvdate']; ?>" data-original-value="<?php echo $purchasemasterdata['srvdate']; ?>" required/>
                                    </div>
                            </div>  
                            <!-- ================== ends ===================== -->                                 
                            <!-- ================== starts ===================== -->
                             <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div class="frmSearch1">
                                        <input type="text" onkeypress="return isNumber(event)" class="form-control" name="purchase_amount" id="purchase_amount"
                            ...
                            <!-- ================== starts ===================== -->
                             <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                    <label class="col-form-label" for="bill_amount"><?php echo 'Bill Amount *'; ?></label>
                                    <div class="frmSearch1">
                                        <?php $billamt = ($purchasemasterdata['bill_amount']>0) ? number_format($purchasemasterdata['bill_amount']):"";
                                        
                                        ?>
                                        <input type="text" onkeypress="return isNumber(event)" class="form-control" name="bill_amount" id="bill_amount" autocomplete="off" value="<?php echo ($billamt); ?>"  data-original-value="<?php echo $billamt; ?>" required/>
                                    </div>
                            </div>  
                            <!-- ================== ends ===================== -->                                     
                            <!-- ================== starts ===================== -->
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="frmSearch1">
                                    <textarea name="note" id="note" class="form-textarea" data-original-value="<?php echo $purchasemasterdata['note']; ?>" title="Note"><?php echo $purchasemasterdata['note']; ?></textarea>
                                </div>
                            </div>
                            <!-- ================== ends ===================== -->                                  
                            <!-- ================== starts ===================== -->
                            ...
                            <table class="table table-striped table-bordered zero-configuration dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:5%; text-align:right"><?php echo $this->lang->line('Bill Amount'); ?></th>
                                ...
                                if(!empty($purchaseitemsdata))
                                {
                                    ...
                                    foreach($purchaseitemsdata as $item){
                                        ...
                                        echo '<td><input type="text" class="form-control" name="product_name[]" id="productname-'.$j.'" value="'.$item['product_name'].'" style="width:350px;" readonly></td>';
                                        echo '<td><input type="text" name="product_code[]" id="product_code-'.$j.'" class="form-control" value="'.$item['product_code'].'" style="width:200px;" readonly><input type="hidden" class="form-control" name="account_code[]" id="account_code-'.$j.'" value="'.$account_code.'" readonly></td>';

                                         //current cost
                                        echo '<td class="text-right">'.$item['cost'].'<input type="hidden" class="form-control" name="old_cost[]" id="old_cost-'.$j.'" value="'.$item['cost'].'" readonly></td>';
                                        ...
                                        echo '<td><input type="number" name="product_qty[]" id="product_qty-'.$j.'" class="form-control" value="'.intval($item['product_qty']).'" style="width:100px;" readonly></td>';

                                        echo '<td><input type="number" name="product_qty_recieved[]" id="product_qty_recieved-'.$j.'" class="form-control received_product"  style="width:100px;" onkeyup="recievedqty_check('.$j.'), productReceivedQty('.$j.'),productwise_costing('.$j.')" value="'.intval($item['product_qty_recieved']).'" title="'.$product_name_with_code.'Received Quantity" data-original-value="'.intval($item['product_qty_recieved']).'" title="Received Quantity"></td>';

                                        echo '<td><input type="text" name="amount[]" id="amount-'.$j.'" class="form-control text-right"  style="width:150px;" value="'.number_format($item['amount'],2).'" readonly></td>';

                                        echo '<td><input type="number" name="product_foc[]" id="product_foc-'.$j.'" class="form-control text-right"  style="width:100px;" onkeyup="productFoc('.$j.')" title="'.$product_name_with_code.'FOC" value="'.$item['product_foc'].'" data-original-value="'.$item['product_foc'].'" title="FOC"></td>';

                                        echo '<td><input type="number" name="damage[]" id="damage-'.$j.'" class="form-control"  style="width:100px;" onkeyup="damagedqty_check('.$j.'),productDamage('.$j.')" title="'.$product_name_with_code.'Damaged Quantity" value="'.intval($item['damage']).'" data-original-value="'.intval($item['damage']).'" title="Damage Quantity"></td>';

                                        $saleprice = ($item['saleprice']==0)?$item['saleprice']:"";
                                        echo '<td><input type="number" name="saleprice[]" id="saleprice-'.$j.'" class="form-control text-right"  style="width:100px;" value="'.number_format($saleprice,2).'" readonly></td>';
                                        ...
                                        echo '<td><input type="text" name="discountamount[]" id="discountamount-'.$j.'" class="form-control text-right"  style="width:150px;" value="'.number_format($item['discountamount'],2).'" readonly></td>';

                                        echo '<td><input type="text" name="netamount[]" id="netamount-'.$j.'" class="form-control text-right"  style="width:150px;" value="'.number_format($item['netamount'],2).'" readonly></td>';

                                        echo '<td><input type="text" name="qaramount[]" id="qaramount-'.$j.'" class="form-control text-right"  style="width:150px;" value='.number_format($item['qaramount'],2).' readonly></td>';
                                        echo '<td><button type="button" class="btn btn-crud btn-sm btn-secondary" name="product_cost_update_btn" id="product_cost_update_btn'.$j.'" onclick="update_product_cost('.$j.')">Update Cost</button></td>';
                                    ...
                                    <tr>
                                        ...
                                        <th class="no-border"></th><th class="no-border"></th><th class="no-border"></th>
                                        <th class="no-border text-right"><span id="totaldiscount"><?php echo number_format($totaldiscount,2); ?></span></th>
                                        <th class="no-border text-right"><span id="totalnetamount"><?php echo number_format($totalnetamount,2); ?></span></th>
                                    ...
                                    <tbody>
                                            ...
                                            $costqaramt = 0;
                                             if(empty($purchaseexpensesdata)){ ?>
                                                ...
                                                <td><input type="text" name="currency_cost[]" id="currency_cost-0" value="<?php echo $purchasemasterdata['currency_id']; ?>" class="form-control" style="width:150px;" readonly></td>

                                                <td><input type="number" name="currency_rate_cost[]" id="currency_rate_cost-0" value="<?php echo $purchasemasterdata['currency_rate']; ?>" class="form-control text-right" style="width:150px;" readonly></td>
                                                ...
                                                <td><textarea name="remarks[]" id="remarks-0" class="form-control" style="width:250px;"></textarea></td><td></td>
                                                </tr>
                                            <?php }
                                            else{
                                                $k=0;
                                                ...
                                                foreach($purchaseexpensesdata as $row){
                                                    ...
                                                    echo '<td><input type="text" name="expense_name[]" id="expense_name-'.$k.'" class="form-control" style="width:150px;" data-id="'.$k.'" placeholder="Expense name" onkeyup="expensedynamicsearch('.$k.')" title="Expense"  data-original-value="'.$row['expense_name'].'" value="'.$row['expense_name'].'"></td>';
                                                    ...
                                                    echo '<td><input type="text" name="payable_acc[]" id="payable_acc-'.$k.'" class="form-control" style="width:250px;" placeholder="Account Name or Number" onkeyup="accountdynamicsearch('.$k.')" data-id="'.$k.'" value="'.$row['payable_acc'].'"  title="Account Name" data-original-value="'.$row['payable_acc'].'"></td>';
                                                    ...
                                                    echo '<td><input type="date" name="bill_date_cost[]" id="bill_date_cost-'.$k.'" class="form-control" style="width:150px;" value="'.$row['bill_date_cost'].'" data-original-value="'.$row['bill_date_cost'].'" title="Bill Date"></td>';
                                                   
                                                    echo ' <td><input type="number" name="costing_amount[]" id="costing_amount-'.$k.'" class="form-control text-right" style="width:100px;" onkeyup="costingamount('.$k.')"  value="'.($row['costing_amount']).'" title="Expense Amount" data-original-value="'.$row['costing_amount'].'" ></td>';
                                                    ...
                                                    echo '<td><input type="number" name="currency_rate_cost[]" id="currency_rate_cost-'.$k.'" value="'.number_format($row['currency_rate_cost'],2).'" class="form-control text-right" style="width:150px;" readonly></td>';
                                                    ...
                                                    echo '<td><input type="text" name="costing_amount_qar[]" id="costing_amount_qar-'.$k.'" class="form-control text-right" style="width:100px;" readonly value="'.number_format($row['costing_amount_qar'],2).'"></td>';
                                                    ...
                                                    echo '<td><button type="button" data-rowid="' . $i . '" class="btn-sm btn-default removeProd border-0" title="Remove"> <i class="fa fa-trash"></i> </button></td>';
                                                    echo '</tr>';
                                                    $k++;
                                                }
                                            } ?>
                                        ...
                                        <tr>
                                            ...
                                            <th class="no-border"></th>
                                            <th class="no-border text-right"><span id="costingNetAmounts"><?=number_format($costnetamt,2)?></span></th>
                                            <th class="no-border text-right"><span id="costingNetAmountQar"><?=number_format($costqaramt,2)?></span></th>
                                        </tr>
                                    </tbody>
                                </table>
            ...
            <div class="col-12 row mb-3">                
                  <div class="col-4 mt-2">
                     ...
                     <?php 
                      if($purchasemasterdata['reciept_status']!='Draft')
                      { ?>
                        <input type="submit" class="btn btn-crud btn-lg btn-secondary cancelreceipt-btn" value="<?php echo $this->lang->line('Cancel Purchase Receipt') ?>">
                     <?php }
                        $draftcls ="";
                  ...
                  <div class="col-8 text-right mt-2" >
                    ...
                    <?php
                        if($purchasemasterdata['prepared_flg']!=1){ ?>
                        <input type="submit" class="btn btn-crud btn-lg btn-primary sub-btn <?=$generatebtn?> <?=$accpetthenhide?>"  value="<?php echo $this->lang->line('c') ?>" id="savebtn" data-loading-text="Creating...">
                        <?php } ?>
                        ...
                        <?php
                        if($purchasemasterdata['approved_by']==$this->session->userdata('id')  &&  $purchasemasterdata['approvalflg']=='1'){
                            ?>
                            ...
                            <input type="submit" class="btn btn-crud btn-lg btn-primary recieve-items-btn <?=$accpetthenhide?>"  value="<?php echo $this->lang->line('Recieve Items') ?>" data-loading-text="">
                        <?php }
...
<button class="history-expand-button">
                ...
                <div class="history-container">
                    ...
                    <table id="log" class="table table-striped table-bordered zero-configuration dataTable">
                        ...
                        <tbody>
                       <?php $i = 1;
                        foreach ($groupedReceipts as $seqence_number => $Receipts){
                        $flag=0;
                        ?>              
                            <tr>
                               <td>        
                                ...
                                {?>
                                <div class="userdata">
                                <img class="rounded-circle1" src='<?php echo base_url('userfiles/employee/thumbnail/'.$Receipt['picture'])?>' style="width:50px; height:50px;" ?>
                                <?php  echo $Receipt['name'];
                                        $flag=1;
                                } ?>
                                </div>           
                                    <ul><li>  <?php echo $Receipt['old_value'];?> > <b><span class="newdata"><?php echo $Receipt['new_value']?></span></b> (<?php if($Receipt['field_label']==""){echo $Receipt['field_name'];}else{echo $Receipt['field_label'];}?>)
                                    </li></ul>
                                    <?php } ?>
                                </td>               
                                <td><?php echo date('d-m-Y H:i:s', strtotime($Receipt['changed_date'])); ?></td>
                                <td><?php echo $Receipt['ip_address']?></td> 
