...
<div class="invoice-box">
    ...
    <table class="party">
        ...
        <tr>
            ...
            <td>
                ...
                if ($invoice['tax_id']) echo '<br>' . $this->lang->line('Tax') . ' ID: ' . $invoice['tax_id'];
                ?>
            </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    echo $invoice['shipping_address_1'] . '<br>' . $invoice['shipping_city'] . '<br> ' . $this->lang->line('Phone') . ': ' . $invoice['shipping_phone'] . '<br> ' . $this->lang->line('Email') . ': ' . $invoice['shipping_email'];
    ...
    <table class="subtotal">
        ...
        <tr class="f_summary">
            ...
            <td><?php echo amountExchange($sub_t, $invoice['multi'])." ". $this->config->item('currency') ?></td>
        </tr>
