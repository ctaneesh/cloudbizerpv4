         ...
         <div id="invoice-template" class="card-body">
            ...
            <form class="payment" name="customerPaymentForm" id="customerPaymentForm" method="POST">
               <div id="invoice-customer-details" class="row">
                  ...
                  <div class="col-md-3 col-sm-12 text-xs-center text-md-left">
                        <input type="hidden" name="customer_id" value="<?=$invoice['cid']?>">
                        <input type="hidden" name="transcation_number" value="<?=$trans_numbers['transcation_number']?>">
                        <input type="hidden" name="reference_number" value="<?=$trans_numbers['reference_number']?>">
                        <input type="hidden" name="banktransaction_number" value="<?=$trans_numbers['banktransaction_number']?>">
                        <input type="hidden" name="old_received_amount" value="<?=$trans_numbers['trans_amount']?>">
                        <?php 
                     ...
                     <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-12">
                           <div class="form-group">
                              ...
                              <input type="date" class="form-control required" placeholder="Payment Date" name="paydate" data-original-value="<?=date('Y-m-d')?>" value="<?=date('Y-m-d')?>" min="<?=date('Y-m-d')?>">
                           </div>
                        </div>
                        <!-- ======================================================== -->
                        <!-- ======================================================== -->
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-12">
                           <div class="form-group">
                              ...
                              <?php
                                     $al_payment_method = $transaction_details['trans_payment_method'];
                                ?>
                             
                              <select name="pmethod" id="pmethod" class="form-control mb-1 required" data-original-value="<?php echo $al_payment_method ?>" required>
                       ...
                       <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-12 cardtype paymentmethod d-none">
                           <div class="row">
                              <div class="col-8">
                                 <div class="form-group">
                                    ...
                                    <input type="number" class="form-control cardrequired paymentrequired" placeholder="Card Number" name="card_number" id="card_number" value="<?=$transaction_ai['card_number']?>" data-original-value="<?=$transaction_ai['card_number']?>">
                                 </div>
                              </div>
                              <div class="col-4">
                                 <div class="form-group">
                                    <label for="cvc" class='col-form-label'>CVC<span class="compulsoryfld"> *</span></label>
                                    <input type="text" class="form-control cardrequired paymentrequired" placeholder="CVC" name="cvc" id="cvc" value="<?=$transaction_ai['cvc']?>" data-original-value="<?=$transaction_ai['cvc']?>">
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-12 cardtype paymentmethod d-none">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control cardrequired paymentrequired" placeholder="Card Holder Name" name="card_holder" id="card_holder" value="<?=$transaction_ai['card_holder']?>" data-original-value="<?=$transaction_ai['card_holder']?>">
                           </div>
                        </div>
                        <!-- ======================================================== -->
                        <!-- ======================================================== -->
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-12 cardtype paymentmethod d-none">
                           <div class="form-group">
                              ...
                              <input type="date" class="form-control cardrequired paymentrequired" placeholder="Card Expiry Date" name="card_expiry_date" id="card_expiry_date" value="<?=$transaction_ai['card_expiry_date']?>" data-original-value="<?=$transaction_ai['card_expiry_date']?>">
                           </div>
                        </div>
                        <!-- ======================================================== -->
                       <!-- ================= type = card ================================= -->
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-12 chequetype paymentmethod d-none">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control chequerequired paymentrequired" placeholder="Pay From" name="cheque_pay_from" id="cheque_pay_from" value="<?=$transaction_ai['cheque_pay_from']?>" data-original-value="<?=$transaction_ai['cheque_pay_from']?>">
                           </div>
                        </div>
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-12 chequetype paymentmethod d-none">
                           <div class="form-group">
                              <label for="cheque_account_number" class='col-form-label'>Cheque Account Number<span class="compulsoryfld"> *</span></label>
                              <input type="number" class="form-control chequerequired paymentrequired" placeholder="Cheque Account Number" name="cheque_account_number" id="cheque_account_number" value="<?=$transaction_ai['cheque_account_number']?>" data-original-value="<?=$transaction_ai['cheque_account_number']?>">
                           </div>
                        </div>
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-12 chequetype paymentmethod d-none">
                           <div class="form-group">
                              <label for="cheque_number" class='col-form-label'>Cheque Number<span class="compulsoryfld"> *</span></label>
                              <input type="number" class="form-control chequerequired paymentrequired" placeholder="Cheque Number" name="cheque_number" id="cheque_number" value="<?=$transaction_ai['cheque_number']?>" data-original-value="<?=$transaction_ai['cheque_number']?>">
                           </div>
                        </div>
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-12 chequetype paymentmethod d-none">
                           <div class="form-group">
                              <label for="cheque_date" class='col-form-label'>Cheque Date<span class="compulsoryfld"> *</span></label>
                              <input type="date" class="form-control chequerequired paymentrequired" placeholder="Cheque Date" name="cheque_date" id="cheque_date" value="<?=$transaction_ai['cheque_date']?>" data-original-value="<?=$transaction_ai['cheque_date']?>">
                           </div>
                        </div>
                        <!-- ================= type = Cheque ================================= -->
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-12 paymentmethod amountsection d-none">
                           <fieldset class="form-group">
                              <label for="Total Amount" class='col-form-label'>Amount<span class="compulsoryfld"> *</span></label>
                        ...
                        <!-- ======================================================== -->
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-12">
                           <input type="hidden" name="account_type_id_old" id="account_type_id_old" value="<?=$default_receivableaccount?>">
                           <input type="hidden" name="bank_account_old" id="bank_account_old" value="<?=$default_bankaccount?>">
                           <div class="form-group"> 
                              <label for="bank_account" class="col-form-label"><?php echo $this->lang->line('Account') ?></label><label><span class="compulsoryfld"> *</span></label>
                              <select name="bank_account" id="bank_account" class="form-control required" data-original-value="<?=$default_bankaccount?>" required>
                        ...
                        <!-- <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-12">
                           ...
                           <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                                <label class="col-form-label" for="account_type_id"><?php echo $this->lang->line('Chart of Account') ?></label><label><span class="compulsoryfld">*</span></label>
                                    
                                <?php
                                    echo '<select name="account_type_id" id="account_type_id" data-original-value="<?php echo $accountheaders ?>" class="form-control">';
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
                           <div class="form-group">
                              ...
                              <textarea type="text" class="form-textarea"  data-original-value="<?php echo $transaction_ai['note'] ?>" name="shortnote" placeholder="Note" required minlength="5"><?=$transaction_ai['note']?></textarea>
                           </div>
                        </div>
                        <!-- ======================================================== -->
                  ...
                  <div class="col-12">
                     ...
                     <table class="table table-striped table-bordered zero-configuration dataTable" id="paymentTable">
                        <thead>
                           <tr>
                              <th width="5%" class="text-center"><?php echo $this->lang->line("Credit Note"); ?></th>
                              <th width="10%" class="text-center"><?php echo $this->lang->line("Invoice"); ?></th>
                        ...
                        <?php 
                           if(!empty($invoice)){
                              $totalval = 0;
                                 ...
                                 echo "<tr>"; 
                                 echo "<td ><a href='" . base_url("invoicecreditnotes/create?iid=" . $invoice['returnid']) . "'>&nbsp;" .  $prefix['invoicereturn_prefix'].$invoice['tid'] . "</a></td>";
                                 echo "<td class='text-center'><a href='" . base_url("invoices/create?id=" . $invoice['invoiceid']) . "'>&nbsp;" . $invoice['invoice_number'] . "</a></td>";
                                 echo "<td class='text-center'>".date('d-m-Y H:i:s', strtotime($invoice['created_dt']))."</td>";
                              ...
                              //echo "<input type='hidden' name='selectedInvoiceamount' id='selectedInvoiceamount' value='0'>";
                               ...
                               echo "<input type='hidden' name='return_number' id='return_number' value='".$invoice['tid']."'>";
                           }
                           ?>
                        </tbody>
                     </table>
            ...
            <div class="col-12 text-right">
               <div class="form-group">
                  ...
                  <input type="hidden" class="form-control required"  name="tid" id="invoiceid" value="<?php echo $invoice['returnid'] ?>">
                  ...
                  <button type="submit" class="btn btn-crud btn-lg btn-primary" id="invoice-return-btn"><?php echo $this->lang->line('Payment Return'); ?></button>
...
$("#pmethod").trigger('change');
  ...
  $("#bank_account").select2({
   ...
   $('#invoice-return-btn').on('click', function(e) {
    e.preventDefault(); // Prevent the default form submission
   //  $('#invoice-return-btn').prop('disabled',true);
    // Validate the form    
      ...
      if (parseFloat(selectedInvoiceamount) < parseFloat(recievedamt) || parseFloat(recievedamt)<=0) {       
        ...
        Swal.fire({
                  ...
                  if (result.isConfirmed) {
                     $.ajax({
                           url: baseurl + "transactions/invoice_return_payment_edit",
                           type: 'POST',
                           data: formData,
                           contentType: false,
                           processData: false,
                     ...
                     $('#invoice-return-btn').prop('disabled', false);
                  }
               });
