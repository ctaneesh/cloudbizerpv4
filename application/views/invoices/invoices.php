 ...
 ?>
    <div class="card">
        <div class="card-header border-bottom">
            ...
            <h4 class="card-title"><?php echo $this->lang->line('Manage Invoices') ?> <a  href="<?php echo base_url('invoices/create') ?>"  class="btn btn-primary btn-sm rounded"><?php echo $this->lang->line('Add new') ?></a></h4>
                    ...
                    <div class="table-scroll">
                        <table id="invoices" class="table table-striped table-bordered zero-configuration">
                            ...
                            <tr>
                                ...
                                <th class="text-center"> <?php echo $this->lang->line('Invoice No') ?></th>
                                <th class="text-center"> <?php echo $this->lang->line('Invoice Type') ?></th>
                                <th class="text-center"> <?php echo $this->lang->line('Payment Type') ?></th>
                                ...
                                <!-- <th class="text-center"><?php echo $this->lang->line('Payment Received')." ".$this->lang->line('Date') ?></th> -->
                                <th class="text-right"><?php echo $this->lang->line('Payment Received') ?></th>                                
                                <th class="text-center"><?php echo $this->lang->line('Status') ?></th>
                                <th class="no-sort d-flex"><?php echo $this->lang->line('Action') ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
