...
//print_r($sheetData);
        ...
        if (count($sheetData[0]) == 9) {
            $out = $this->db->insert_batch('cberp_products', $products);
            if ($out) {
...
//print_r($sheetData);
        ...
        foreach ($sheetData as $row) {
            ...
            $data[] = array(
                ...
                'tax_id' => $row[9],
                'company' => $row[10],
                'shipping_name' => $row[11],
                'shipping_phone' => $row[12],
                'shipping_email' => $row[13],
                'shipping_address_1' => $row[14],
                'shipping_city' => $row[15],
                'shipping_region' => $row[16],
                'shipping_country' => $row[17],
                'shipping_postbox' => $row[18]
            );
        ...
        if (count($sheetData[0]) == 19) {
            $out = $this->db->insert_batch('cberp_customers', $data);
