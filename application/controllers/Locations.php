...
class Locations extends CI_Controller
{
    ...
    public function create()
    {
        if ($this->input->post()) {
            ...
            $this->locations->create($name, $address, $city, $region, $country, $postbox, $phone, $email, $tax_id, $image, $cur_id, $ac_id, $wid);
        } else {
    ...
    public function edit()
    {
        if ($this->input->post()) {
            ...
            $wid = $this->input->post('wid');
            $this->locations->edit($id, $name, $address, $city, $region, $country, $postbox, $phone, $email, $tax_id, $image, $cur_id, $ac_id, $wid);
        } else {
    ...
    public function delete_i()
    {
        ...
        if ($id) {
            ...
            $this->db->delete('cberp_locations', array('id' => $id));
    ...
    public function load_list()
    {
        ...
        foreach ($list as $promo) {
            ...
            $row[] = '<a href="#" class="btn btn-secondary btn-sm rounded set-task" data-id="' . $promo->id . '" data-stat="0"> SET </a> <a href="#" data-object-id="' . $promo->id . '" class="btn btn-secondary btn-sm delete-object"><span class="icon-bin"></span></a>';
