...
class Purchase extends CI_Controller
{
    ...
    public function create()
    {
        ...
        // print_r($data['products']); die(); warehouse
    ...
    public function action()
    {
        ...
        if($purchase_number_exists > 0)
        {
            ...
            if($this->input->post('approval_level')=='1')
            {
                detailed_log_history($this->module_number,$purchase_number,'Purchase Order Approved', $_POST['changedFields']);
                $message = "Purchase Order(".$purchase_number.") Approved";
                send_message_to_users($users_list,$target_url,$message_caption,$message,datefordatabase($duedate));
            }
            else{
                detailed_log_history($this->module_number,$purchase_number,'Created','');
                send_message_to_users($users_list,$target_url,$message_caption,$message,datefordatabase($duedate));
            }
        ...
        else
        {
            ...
            if ($this->db->insert('cberp_purchase_orders', $data)) {
                ...
                $this->db->insert('cberp_transaction_tracking',['purchase_order_number'=>$purchase_number]);
    ...
    public function approval_action()
    {
        ...
        // erp2025 09-01-2025 starts
          detailed_log_history($this->module_number,$purchase_number,'Updated', $_POST['changedFields']);	
        // erp2025 09-01-2025 ends   
        // die($this->db->last_query());
    ...
    //    error_reporting(E_ALL);
        ...
        $targeturl = base_url("authorization_approval");
        // erp2025 09-01-2025 starts
        $sequence_number = detailed_log_history($this->module_number,$purchase_number,'Purchase order Send', $_POST['changedFields']);	
        // erp2025 09-01-2025 ends  
        // file upload section starts 22-01-2025
            if($_FILES['upfile'])
            {
    ...
    public function revertorder_action()
    {
        ...
        // erp2025 09-01-2025 starts
        detailed_log_history($this->module_number,$po_id,'Purchase order Reverted', $_POST['changedFields']);	
        // erp2025 09-01-2025 ends   
    ...
    public function po_accept()
    {
        ...
        // erp2025 09-01-2025 starts
         detailed_log_history($this->module_number,$po_id,'Purchase order Accepted & Send', $_POST['changedFields']);	
        // erp2025 09-01-2025 ends   
