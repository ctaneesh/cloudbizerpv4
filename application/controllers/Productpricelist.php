...
class Productpricelist extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('productpricelist_model', 'productpricelist');
    ...
    public function index()
    {
        ...
        $head['title'] = "Product Stock & Price Lists";
        $head['usernm'] = $this->aauth->get_user()->username;        
        $data['units'] = $this->productpricelist->get_datatables();
        // echo "<pre>"; print_r($data['units']); die();
        $this->load->view('fixed/header', $head);
        $this->load->view('productprice/index', $data);
    ...
    public function create()
    {
        if ($this->input->post()) {
            ...
            $this->productpricelist->create($price_perc, $selling_price_perc, $whole_price_perc, $web_price_perc);
            
        } else {


            $head['title'] = "Add Produc Pricing";
            $head['usernm'] = $this->aauth->get_user()->username;
            $this->load->view('fixed/header', $head);
    ...
    public function edit()
    {
        if ($this->input->post()) {
            ...
            $whole_price_perc = $this->input->post('whole_price_perc', true);
            $web_price_perc = $this->input->post('web_price_perc', true);
            $this->productpricelist->edit($id, $price_perc, $selling_price_perc, $whole_price_perc, $web_price_perc);
        } else {


            $head['title'] = "Edit Product Pricing";
            $head['usernm'] = $this->aauth->get_user()->username;
            $data = $this->productpricelist->view($this->input->get('id'));
            $this->load->view('fixed/header', $head);
    ...
    public function variations()
    {
        ...
        $data['units'] = $this->productpricelist->variations_list();
        $head['usernm'] = $this->aauth->get_user()->username;
        $this->load->view('fixed/header', $head);
    ...
    public function create_va()
    {
        if ($this->input->post()) {
            ...
            $this->productpricelist->create_va($name, 1);
        } else {
    ...
    public function edit_va()
    {
        if ($this->input->post()) {
            ...
            $this->productpricelist->edit_va($id, $name);
        } else {
    ...
    public function variables()
    {
        ...
        $data['units'] = $this->productpricelist->variables_list();
        $head['usernm'] = $this->aauth->get_user()->username;
        $this->load->view('fixed/header', $head);
    ...
    public function create_vb()
    {
        if ($this->input->post()) {
            ...
            $this->productpricelist->create_vb($name, $var_id);
        } else {


            $head['title'] = "Add variation variable";
            $head['usernm'] = $this->aauth->get_user()->username;
            $data['variations'] = $this->productpricelist->variations_list();
            $this->load->view('fixed/header', $head);
    ...
    public function edit_vb()
    {
        if ($this->input->post()) {
            ...
            $this->productpricelist->edit_vb($id, $name, $var_id);
        } else {
