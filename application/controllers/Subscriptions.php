...
class Subscriptions extends CI_Controller
{
    ...
    public function action()
    {
        ...
        if ($this->db->insert('cberp_invoices', $data)) {
            ...
            // echo json_encode(array('status' => 'Success', 'message' => $this->lang->line('Invoice Success') . " <a href='view?id=$invocieno' class='btn btn-sm btn-blue'><span class='fa fa-file-text' aria-hidden='true'></span> " . $this->lang->line('View') . "  </a> &nbsp; &nbsp; <a href='$link' class='btn btn-sm btn-purple'><span class='fa fa-globe' aria-hidden='true'></span> " . $this->lang->line('Public View') . " </a>"));
        } else {
    ...
    public function editaction()
    {
        ...
        if ($this->db->update('cberp_invoices', $data)) {
            ...
            if ($prodindex > 0) {
                ...
                $this->db->where('id', $iid);
                $this->db->update('cberp_invoices');
                echo json_encode(array('status' => 'Success', 'message' => $this->lang->line('Invoice has  been updated') . " <a href='view?id=$iid' class='btn btn-info btn-sm'><span class='fa fa-eye' aria-hidden='true'></span> " . $this->lang->line('View') . " </a> "));
            } else {
                echo json_encode(array('status' => 'Error', 'message' =>
                    $this->lang->line('ERROR')));
                $transok = false;
