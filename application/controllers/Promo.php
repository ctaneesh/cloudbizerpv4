...
class Promo extends CI_Controller
{
    ...
    {
        $data['permissions'] = load_permissions('Promo Codes','Coupns','Manage Promo');
        $head['title'] = "Promo";
    ...
    {
        $data['permissions'] = load_permissions('Promo Codes','Coupns','New Promo Code');
        if ($this->input->post()) {
    ...
    public function delete_i()
    {
        ...
        if ($id) {
            ...
            $this->db->delete('cberp_promo', array('id' => $id));
    ...
    public function load_list()
    {
        ...
        foreach ($list as $promo) {
            ...
            $row[] = '<a href="#" class="btn btn-primary btn-sm rounded set-task breaklink" data-id="' . $promo->id . '" data-status="' . $promo->active . '" data-stat="0"> SET </a> <a href="#" data-object-id="' . $promo->id . '" class="btn btn-danger btn-sm delete-object"><span class="fa fa-trash"></span></a>';
