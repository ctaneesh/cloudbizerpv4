...
class Enquiry_model extends CI_Model
{
    ...
    // $this->db->select('customer_enquiry.*,'cberp_customers.name','cberp_customers.phone',cberp_customers.address,cberp_customers.city,cberp_customers.region,cberp_customers.country,cberp_customers.postbox,cberp_customers.email,cberp_customers.gid,cberp_customers.company,cberp_customers.tax_id');
    var $column_order = array(null, 'customer_enquiry.lead_id','cberp_customers.name','cberp_customers.phone', 'customer_enquiry.enquiry_requested_date', 'customer_enquiry.enquiry_date',  '.customer_enquiry.status', null);
    var $column_search = array('customer_enquiry.lead_id','cberp_customers.name','cberp_customers.phone', 'customer_enquiry.enquiry_requested_date', 'customer_enquiry.enquiry_date',  '.customer_enquiry.status');
