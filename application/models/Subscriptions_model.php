...
class Subscriptions_model extends CI_Model
{
    ...
    var $column_order = array(null, 'cberp_invoices.tid', 'cberp_customers.name', 'cberp_invoices.invoicedate', 'cberp_invoices.total', 'cberp_invoices.status', null, null);
    ...
    {
        $this->db->select('cberp_invoices.id,cberp_invoices.tid,cberp_invoices.invoicedate,cberp_invoices.invoiceduedate,cberp_invoices.total,cberp_invoices.status,cberp_invoices.i_class,cberp_customers.name');
        $this->db->from($this->table);
