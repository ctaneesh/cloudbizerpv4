...
class Productpricing_model extends CI_Model
{
    var $table = 'cberp_product_min_price';
    var $column_order = array(null, 'id','price_perc','selling_price_perc','whole_price_perc','web_price_perc', null);
    var $column_search = array('id','price_perc','selling_price_perc','whole_price_perc','web_price_perc');
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->select('cberp_product_min_price.*');
