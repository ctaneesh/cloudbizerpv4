...
class Customer_enquiry_model extends CI_Model
{
    ...
    public function enquiry_details($id)
    {
        ...
        $this->db->select('cberp_customer_leads.*,cberp_employees.name as employee,cberp_customers.name as customer_name, cberp_customers.phone as customer_phone, cberp_customers.email as customer_email, cberp_customers.address as customer_address');
    ...
    {
        $this->db->select('cberp_customer_lead_items.*, cberp_products.onhand_quantity AS totalQty, cberp_products.alert_quantity, cberp_product_description.product_code,cberp_product_description.product_name,cberp_product_pricing.minimum_price as lowestprice,cberp_products.maximum_discount_rate as max_disrate');
