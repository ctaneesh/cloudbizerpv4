...
$(document).ready(function() {
    ...
    $("#supplier_data_edit_form").validate({
        rules: {
            name: {required:true},
            phone: {required:true},
            email: {
...
function add_existing_values_to_invoice(pid){
    ...
    var functionNum = "'" + cvalue + "'";
    count = $('#saman-row div').length;
    var data = '<tr><td><input type="text" class="form-control" name="product_name[]" placeholder="Search by Product Name or Item No." id="productname-' + cvalue + '" readonly></td><td><input type="number" class="form-control req amnt" name="product_qty[]" id="amount-' + cvalue + '" onkeypress="return isNumber(event)" onkeyup="rowTotal(' + functionNum + '), billUpyog()" autocomplete="off" value="1"  inputmode="numeric" readonly><input type="hidden" id="alert-' + cvalue + '" value=""  name="alert[]"> </td><td><input type="text" class="form-control req prc" name="product_price[]" id="price-' + cvalue + '" onkeypress="return isNumber(event)" onkeyup="rowTotal(' + functionNum + '), billUpyog()" autocomplete="off" inputmode="numeric" readonly></td>';
    ...
    $.ajax({
        ...
        success: function (data) {
            if(data!=""){
                ...
                $("#productname-" + cvalue).val(prdfull);
                ...
                {                    
                    $('#discountamt-' + cvalue).val(data[0][4]);
...
$(document).ready(function() {
    ...
    // if (isUrlInArray(currentURL, predefinedUrls)) {
        ...
        // Before leaving the page or reloading, show confirmation if there are unsaved changes
...
function checkDiscountRate() {
    ...
    var maxDisrate = parseFloat($("#max_disrate").val());
